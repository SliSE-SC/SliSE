...
contract BioCoinPreSale {
    BioCoin public token;
    address public beneficiary;
    address public alfatokenteam;
    uint public amountRaised;
    uint public bonus;

    uint constant public price = 3330000000000000;
    uint constant public minSaleAmount = 1000000000000000000;

    function BioCoinPreSale(
        BioCoin _token,
        address _beneficiary,
        address _alfatokenteam,
        uint _bonus
    ) {
        token = BioCoin(_token);
    ...
    function () payable {
        ...
        uint tokenAmount = (amount / price) * 1000000000000000000;
