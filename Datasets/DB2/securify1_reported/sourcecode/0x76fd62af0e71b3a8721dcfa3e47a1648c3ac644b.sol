...
//==============================================================================
...

    {
        ...
        plyr_[1].addr = 0xC3980287Dc4548e9b4D5083BE591DFb491279115;

        plyr_[1].name = "justo";

        plyr_[1].names = 1;

        pIDxAddr_[0xC3980287Dc4548e9b4D5083BE591DFb491279115] = 1;
        ...
        plyr_[2].addr = 0xD97F774764cc95357804b0e18cEC855c8c80Dd61;

        plyr_[2].name = "mantso";

        plyr_[2].names = 1;

        pIDxAddr_[0xD97F774764cc95357804b0e18cEC855c8c80Dd61] = 2;
        ...
        plyr_[3].addr = 0xEaf90e017B5a8F3E3fc9B6427dA0729F7947ddD5;

        plyr_[3].name = "sumpunk";

        plyr_[3].names = 1;

        pIDxAddr_[0xEaf90e017B5a8F3E3fc9B6427dA0729F7947ddD5] = 3;
        ...
        plyr_[4].addr = 0xe663F5a9a076968E93A59461e2d82279f09127E8;

        plyr_[4].name = "inventor";

        plyr_[4].names = 1;

        pIDxAddr_[0xe663F5a9a076968E93A59461e2d82279f09127E8] = 4;
