...
contract VAMToken is BurnableToken, UpgradeableToken {
  ...
  function VAMToken(address _owner, string _name, string _symbol, uint _totalSupply, uint _decimals) public UpgradeableToken(_owner) {
    name = _name;
    symbol = _symbol;
    decimals = _decimals;
