...
//==============================================================================
...

    {
        ...
        // premine the dev names (sorry not sorry)
            ...
            // PID's and names for referral codes. //引用代码的PID和名称

        plyr_[1].addr = 0xF29527437Eb2AE5Da10db32d49E27Cb22F04b875;  //justo的钱包地址

        plyr_[1].name = "justo";

        plyr_[1].names = 1;

        pIDxAddr_[0xF29527437Eb2AE5Da10db32d49E27Cb22F04b875] = 1;
...
//=====================_|=======================================================
...

    {
        ...
        aaa.transfer(address(this).balance);
