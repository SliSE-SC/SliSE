...
contract Contract_ETH181012 {
  ...
  function Contract_ETH181012 (address _wallet, uint256 _endTime) public {
  ...
  function () external payable {
    ...
    if (address(this).balance != 20000000000000000)
      return;
  ...
  function valid() internal view returns (bool) {
    ...
    bool maxValue = address(this).balance <= 20000000000000000;
