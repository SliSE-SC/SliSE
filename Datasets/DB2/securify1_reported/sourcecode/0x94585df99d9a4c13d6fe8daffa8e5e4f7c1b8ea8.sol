...
contract VMToken is BurnableToken, UpgradeableToken {
  ...
  function VMToken(address _owner, string _name, string _symbol, uint _totalSupply, uint _decimals) public UpgradeableToken(_owner) {
    name = _name;
    symbol = _symbol;
    decimals = _decimals;
