...
pragma solidity ^0.4.4;
  ...
  //RUS::Если вы нашли баги или есть идеи, пишите нам [email protected]
...
//RUS::PlayFiveChain - главная функция игры, шлёт этой функции символы билета и символы введеные игроком
...
//ENG::Using multiple variables to generate HASH (c2)
