...
contract PXP is MiniMeToken {
    ...
    function init(
      ...
      address ieo
        ...
        super.generateTokens(founder, 10e26);

        super.generateTokens(team, 10e26);

        super.generateTokens(advisor, 5e26);

        super.generateTokens(airdrop, 5e26);

        super.generateTokens(marketing, 20e26);

        super.generateTokens(ieo, 50e26);
