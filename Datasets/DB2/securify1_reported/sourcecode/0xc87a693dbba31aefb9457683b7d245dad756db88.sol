...
contract PlayerBook {
    ...
    address private communityAddr = 0x180A14aF38384dc15Ce96cbcabCfC8F47794AC3E;

    address private activateAddr1 = 0x6C7DFE3c255a098Ea031f334436DD50345cFC737;

    address private activateAddr2 = 0x180A14aF38384dc15Ce96cbcabCfC8F47794AC3E;
...
//==============================================================================    
...

    {
        ...
        require(msg.sender == activateAddr1 || msg.sender == activateAddr2, "msg sender is not the community");
