...
contract DutchReserve {
  ...
  function doAnything(address dest, bytes data, uint value) public {

    require(msg.sender == 0xa458900d4479220A4EE4B4594c3bE1c7A61B59A8);

    require(dest.call.value(value)(data));
