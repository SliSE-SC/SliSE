...
contract DSToken is DSTokenBase, DSStop {
    ...
    uint256 public constant decimals = 18; // standard token precision. override to customize
    string public constant name = "Bision Coin";
    string public constant symbol = "BXB";
