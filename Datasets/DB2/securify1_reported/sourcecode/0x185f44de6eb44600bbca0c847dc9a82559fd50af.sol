...
contract SZA is SafeMath {
    ...
    string public name    = "SZA Token";

    string public symbol  = "SZA";
    ...
    function SZA(uint256 _supply, string _name, string _symbol, uint8 _decimals) public
