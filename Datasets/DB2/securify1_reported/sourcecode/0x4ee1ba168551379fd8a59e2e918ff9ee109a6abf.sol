...
//==============================================================================    
...

    {
		...
		//reminder---should also add them into the addGame() function
 ...
 *                           │ Optional Wrappers For TeamDream │
 ...
 *     function multiSig(bytes32 _whatFunction) private returns (bool) {return(MSFun.multiSig(msData, TeamDream.requiredSignatures(), _whatFunction));}
