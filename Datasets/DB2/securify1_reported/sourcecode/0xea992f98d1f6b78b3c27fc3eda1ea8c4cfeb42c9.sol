...
contract RefundSafe is HasOwner {
    ...
    /**
     * @dev The modifier ensures that the RefundSafe is in active state 
     */
    modifier isActive() {
...
contract RefundableFundraiser is FinalizableFundraiser {
    ...
    /**
     * @dev Overrides the setBeneficiary function to set the beneficiary of the refund safe
     *
     * @param _beneficiary The address of the beneficiary.
     */
    function setBeneficiary(address _beneficiary) public onlyOwner {
     ...
     * to check if soft cap was reached and appropriately allow refunds
...
contract LotusTokenFundraiser is MintableTokenFundraiser, IndividualCapsFundraiser, CappedFundraiser, RefundableFundraiser, GasPriceLimitFundraiser {
        ...
        public
    {
        ...
        initializeBasicFundraiser(
            1563706800, // Start date = 2019-07-21 11:00 UTC
            1573776000,  // End date = 2019-11-15 00:00 UTC
            5000, // Conversion rate = 5000 LTS per 1 ether
            0x4C62600f490f5f051646680f094C1AcB1f971fF7     // Beneficiary
        );
