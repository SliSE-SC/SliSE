...
/**
* Traceability Blockchain Token (TRACIO).
* Powers the Traceability Blockchain dApps.
* Based on OpenZeppelin (Source Code from FARM Token).
* Hard Cap: 25,000,000 tokens.
*/
...
// File: contracts/txtSchedules.sol

contract tracIOToken is ERC20, ERC20Detailed, ERC20Capped, Governable {

  uint256 public constant HARD_CAP = 25 * (10 ** 6) * (10 ** 18);

  constructor(address _storage) public
  ERC20Detailed("TRACIO Token", "TRACIO", 18)
