...
contract ForeignBridge is ERC677Receiver, BasicBridge {
    ...
    function upgradeFrom1To2() public {
        ...
        require(!boolStorage[keccak256("isUpgradedFrom1To2")]);

        uintStorage[keccak256("homeDailyLimit")] = 3000000 ether;

        emit HomeDailyLimit(3000000 ether);

        uintStorage[keccak256("homeMaxPerTx")] = 1500000 ether;
