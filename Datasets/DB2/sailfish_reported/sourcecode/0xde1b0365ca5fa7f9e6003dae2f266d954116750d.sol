...
// File: node_modules\openzeppelin-solidity\contracts\drafts\TokenVesting.sol
...
// File: contracts\TokenVested.sol



/**

 * Copyright (c) 2019 GG International Ltd
...
contract TokenVested is TokenVesting {

    address public beneficiary = msg.sender;

    uint256 public start = 1554130800;

    uint256 public cliffDuration = 31556952;

    uint256 public duration = 31556952;

    bool public revocable = false;
