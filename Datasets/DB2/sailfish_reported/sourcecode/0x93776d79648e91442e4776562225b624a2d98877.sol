...
contract APP_Token is BurnableToken, Owned {
    string public constant name = "Asia Pacific Peace";
    string public constant symbol = "APP";
    uint8 public constant decimals = 18;
 
    /// Maximum tokens to be allocated ( 1 billion APP)
    ...
    constructor(address _saleTokensAddress) public payable {
        ...
        /// Maximum tokens to be sold - 500 million
        uint256 saleTokens = 500000000;
    ...
    function createReserveTokensVault() external onlyOwner {
        ...
        /// Reserve tokens - 500 million 
        uint256 reserveTokens = 500000000;
