...
contract BKB_Token is BurnableToken, Owned {
    ...
    /// Maximum tokens to be allocated ( 0.9 billion BKB)
    ...
    constructor(address _saleTokensAddress) public payable {
        ...
        /// Maximum tokens to be sold - 89.5 %
    ...
    /// @dev vest the sale contributor tokens for 100 days, 1% gradual release with 3 month cliff
