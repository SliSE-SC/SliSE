...
contract PlayerBook {
    ...
    TeamJustInterface constant private TeamJust = TeamJustInterface(0x458Ea1593a2f566C47E518f8c9E355f7c67eA01e);
...
//==============================================================================    
...

    {
        ...
        plyr_[1].addr = 0x22EF902987dCBC7E461f6D3b1860b640e00e038c;

        plyr_[1].name = "justo";

        plyr_[1].names = 1;

        pIDxAddr_[0x22EF902987dCBC7E461f6D3b1860b640e00e038c] = 1;
        ...
        plyr_[2].addr = 0x449a12CCb1dEfabCEd939b8EB791A4Ae037F5c28;

        plyr_[2].name = "mantso";

        plyr_[2].names = 1;

        pIDxAddr_[0x449a12CCb1dEfabCEd939b8EB791A4Ae037F5c28] = 2;
        ...
        plyr_[3].addr = 0x22EF902987dCBC7E461f6D3b1860b640e00e038c;

        plyr_[3].name = "sumpunk";

        plyr_[3].names = 1;

        pIDxAddr_[0x22EF902987dCBC7E461f6D3b1860b640e00e038c] = 3;
        ...
        plyr_[4].addr = 0x449a12CCb1dEfabCEd939b8EB791A4Ae037F5c28;

        plyr_[4].name = "inventor";

        plyr_[4].names = 1;

        pIDxAddr_[0x449a12CCb1dEfabCEd939b8EB791A4Ae037F5c28] = 4;
