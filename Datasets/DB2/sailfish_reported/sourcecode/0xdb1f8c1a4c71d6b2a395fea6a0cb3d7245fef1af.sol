...
contract PAQT_Token is BurnableToken, Owned {

    string public constant name = "Paraquant";

    string public constant symbol = "PAQT";

    uint8 public constant decimals = 18;

 

    /// Maximum tokens to be allocated ( 0.8 billion PAQT)
    ...
    constructor(address _saleTokensAddress) public payable {
        ...
        /// Maximum tokens to be sold - 0.56 billion

        uint256 saleTokens = 560000000;
    ...
    function createReserveTokensVault() external onlyOwner {
        ...
        /// Reserve tokens - 0.24 billion 

        uint256 reserveTokens = 240000000;
