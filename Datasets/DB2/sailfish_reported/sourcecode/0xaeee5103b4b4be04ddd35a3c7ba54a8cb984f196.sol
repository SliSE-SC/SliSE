...
contract ERC721Metadata is ERC165, ERC721, IERC721Metadata {
    ...
    function tokenURI(uint256 tokenId) external view returns (string memory) {
        ...
        infoUrl = strConcat('https://cryptozr.net/v1/', uint2str(tokenId));
        return infoUrl;
    }
}
...
contract CryptoZR is ERC721Full, ERC721Mintable, Ownable {
    using SafeMath for uint256;
    ...
    function reset(uint256 _newtid) public onlyOwner{
        tid = _newtid;
    }
