...
/**
 * Contract acts as an interface between the AceAirdrops contract and all ERC20 compliant
 * tokens. 
 * */
...
contract AceAirdrops is Ownable {
    ...
    /**
     * Checks whether or not an ERC20 token has used its free trial Air drops. This is a constant 
