...
contract FeeApprover is OwnableUpgradeSafe {
    ...
    function initialize(
        ...
        _editNoFeeList(0xf983EcF91195bD63DE8445997082680E688749BC, true); // tensvault proxy
    ...
    function calculateAmountsAfterFee(        
        ...
        ) public returns (uint256 transferToAmount, uint256 transferToFeeDistributorAmount, uint256 burnAmount) 
        {
            ...
            if(noFeeList[sender]) { // Dont have a fee when tensvault is sending, or infinite loop                       // And when pair is sending ( buys are happening, no tax on it)
