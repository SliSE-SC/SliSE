...
contract FeeApprover is OwnableUpgradeSafe {
    ...
    function initialize(
        ...
        tokenUniswapPair = IUniswapV2Factory(_uniswapFactory).getPair(WETHAddress,nanocoreTokenAddress);
        feePercentX100 = 15;
    ...
    function setNanocoreVaultAddress(address _nanocoreVaultAddress) public onlyOwner {
