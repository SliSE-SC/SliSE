...
contract UpgradeableToken is StandardTokenExt {
   ...
   */
  /* conflict with CrowdsaleToken.canUpgrade */
  /* function canUpgrade() public returns(bool) { */
  /*    return true; */
  /* } */
...
contract CrowdsaleToken is ReleasableToken, MintableToken, UpgradeableToken {
  ...
  function CrowdsaleToken(string _name, string _symbol, uint _initialSupply, uint _decimals, bool _mintable) public
    ...
    if(!_mintable) {
      ...
      require(totalSupply != 0);  // Cannot create a token without supply and no minting
    }
  }
