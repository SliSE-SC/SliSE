...
contract Domir223Token_12 is ERC20, ERC223, Standard223Receiver, SafeMath {
...
//from ExampleToken
    ...
    constructor(/*uint initialBalance*/) public {
        ...
        name        = "Domir";                       // Set the name for display purposes
        symbol      = 'DORT';                            // Set the symbol for display purposes
