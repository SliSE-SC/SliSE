...
//==============================================================================    
    ...
    {   
        ...
        plyr_[1].addr = 0x2d33f9F10300De03318b87AaD6Ac169231cB26d0;
        plyr_[1].name = "cn";
        plyr_[1].names = 1;
        pIDxAddr_[0x2d33f9F10300De03318b87AaD6Ac169231cB26d0] = 1;
        pIDxName_["cn"] = 1;
        plyrNames_[1]["cn"] = true;
        plyrNameList_[1][1] = "cn";
...
//=====================_|=======================================================    
        ...
        private
    {
        ...
        // fire event
        emit onNewName(_pID, _addr, _name, _isNewPlayer, _affID, plyr_[_affID].addr, plyr_[_affID].name, now);
    }
//==============================================================================
//    _|_ _  _ | _  .
//     | (_)(_)|_\  .
