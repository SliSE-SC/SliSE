...
contract FeeApprover is OwnableUpgradeSafe {
    ...
    function initialize(
        address _DFCOREAddress,
        address _WETHAddress,
        address _uniswapFactory
    ) public initializer {
        OwnableUpgradeSafe.__Ownable_init();
        dfcoreTokenAddress = _DFCOREAddress;
        WETHAddress = _WETHAddress;
        tokenUniswapPair = IUniswapV2Factory(_uniswapFactory).getPair(WETHAddress,dfcoreTokenAddress);
        feePercentX100 = 20;
    ...
    address dfcoreTokenAddress;
    address dfcoreVaultAddress;
    ...
    function setDFcoreVaultAddress(address _dfcoreVaultAddress) public onlyOwner {
        dfcoreVaultAddress = _dfcoreVaultAddress;
    }
    ...
    function calculateAmountsAfterFee(
        ...
        ) public  returns (uint256 transferToAmount, uint256 transferToFeeDistributorAmount)
        {
            ...
            if(sender == dfcoreVaultAddress  || sender == tokenUniswapPair ) { // Dont have a fee when dfcorevault is sending, or infinite loop
