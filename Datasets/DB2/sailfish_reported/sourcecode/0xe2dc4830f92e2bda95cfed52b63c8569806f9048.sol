...
contract BasicToken is ERC20Basic {
    ...
    * @dev total number of tokens in existence
    */
    function totalBurnedOut() public view returns (uint256) {
        return totalBurnedOut_;
    }
...
contract BurnableToken is StandardToken {
    ...
    function burn(uint256 _value) public {
        ...
        // Burned out token amount
        totalBurnedOut_ = totalBurnedOut_.add(_value);

        emit Burn(burner, _value);
    }
}

contract BOB_Token is BurnableToken, Owned {
    string public constant name = "BIKOBANK";
    string public constant symbol = "BOB";
    uint8 public constant decimals = 18;
 
    /// Burned token amount
    uint256 public constant BURN_OUT = 50000000 * 10**uint256(decimals);

    /// Maximum tokens to be allocated ( 75 million BOB)
    uint256 public constant HARD_CAP = 75000000 * 10**uint256(decimals);
    ...
    constructor(address _saleTokensAddress) public payable {
        ...
        /// Maximum tokens to be sold - 69 million
        uint256 saleTokens = 69000000;
    ...
    function createReserveTokensVault() external onlyOwner {
        ...
        /// Reserve tokens - 6 million 
        uint256 reserveTokens = 6000000;
