...
/**
 * Contract for Invictus Gold Plus (IGP) fund.
 *
 */
contract IGPToken is Initializable, ERC20Detailed, ERC20Burnable, Ownable, Pausable, MinterRole {
    ...
    function initialize(uint256 priceNumeratorInput, address whitelistContractInput, address stableContractInput) public initializer {
        ERC20Detailed.initialize("Invictus Gold Plus", "IGP", 18);
