...
contract DClearAllocation is Ownable {
  ...
  uint256 public initTime = 1565193600;//2019-08-08 00:00:00
  uint256 public periodMintReleased = 0;
  uint256 public periodMintDuration = 31104000;//1 year
  ...
  /**
   * event for token mint special logging
  ...
  /**
   * @dev Creates a new DClearAllocation contract
   */
