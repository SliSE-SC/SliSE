...
// https://github.com/amisolution/ERC20-AMIS/blob/tree/master/contracts/OnChainOrderBookV013b.sol
...
contract OnChainOrderBookV014b {
...
contract OnChainOrderBookV014bFactory {
    ...
    function createBook(ERC20 _baseToken, ERC20 _rwrdToken, address _feeCollector, uint _baseMinInitialSize, int8 _minPriceExponent) public {
        ...
        OnChainOrderBookV014b book = new OnChainOrderBookV014b();
