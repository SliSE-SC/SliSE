...
contract Token is ERC20, ERC20Detailed, ERC20Capped, Governable {

  uint256 public constant HARD_CAP = (1 / 4) * (10 ** 6) * (10 ** 18);

  constructor() public
  ERC20Detailed("TokenBot", "TKB", 18)
  ERC20Capped(HARD_CAP)
  Governable(0x20eFD5EE7F545Cd4c6E221a8CB2615838ac4190e) {
