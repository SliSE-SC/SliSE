...
contract PLOWToken is ERC20, ERC20Detailed, ERC20Capped, Governable {

  uint256 public constant HARD_CAP = (5 / 2) * (10 ** 6) * (10 ** 18);

  constructor() public
  ERC20Detailed("PLOW Token", "PLOW", 18)
  ERC20Capped(HARD_CAP)
  Governable(0xEE4CEFF007C1A617C285eCdF3361d1d971714f62) {
