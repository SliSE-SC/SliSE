...
contract FeeApprover is OwnableUpgradeSafe {
    ...
    function initialize(
        address _upcoreAddress,
        address _WETHAddress,
        address _uniswapFactory
    ) public initializer {
        OwnableUpgradeSafe.__Ownable_init();
        upcoreTokenAddress = _upcoreAddress;
        WETHAddress = _WETHAddress;
        tokenUniswapPair = IUniswapV2Factory(_uniswapFactory).getPair(WETHAddress,upcoreTokenAddress);
        feePercentX100 = 11;
    ...
    address upcoreTokenAddress;
    address upcoreVaultAddress;
    ...
    function setupcoreVaultAddress(address _upcoreVaultAddress) public onlyOwner {
        upcoreVaultAddress = _upcoreVaultAddress;
    }
    ...
    function calculateAmountsAfterFee(
        ...
        ) public  returns (uint256 transferToAmount, uint256 transferToFeeDistributorAmount)
        {
            ...
            if(sender == upcoreVaultAddress  || sender == tokenUniswapPair ) { // Dont have a fee when upcorevault is sending, or infinite loop
