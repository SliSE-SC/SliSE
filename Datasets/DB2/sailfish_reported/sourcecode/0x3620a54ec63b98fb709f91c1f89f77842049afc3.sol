...
contract DMCDelegator is DMCTokenInterface, DMCDelegatorInterface {
     ...
     */
    function _setImplementation(address implementation_, bool allowResign, bytes memory becomeImplementationData) public {
        require(msg.sender == gov, "DMCDelegator::_setImplementation: Caller must be gov");
    ...
    function () external payable {
        require(msg.value == 0,"DMCDelegator:fallback: cannot send value to fallback");
