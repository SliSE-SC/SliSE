...
// File: interfaces\kanpai\IProxy.sol
...
// File: contracts\strategies\StrategyProxy.txt
...
contract StrategyProxy {
    ...
    IProxy public constant proxy = IProxy(0x3ab34f0Dec7c3E3563641Ffd434E16Ca9Cb2463C);
    address public constant mintr = address(0xe3BCd078252C419AF4EcD04331800BA448e880aE);
    address public constant crv = address(0xF69EEe3F3FA73A4f58c4bc6c6C2B28383c35ABeE);
    address public constant gauge = address(0x0226109Bb449B6056c9cCF2881FAD61Fa7A67f2D);
    address public constant k = address(0x706087Fa3cC8Ef2265892540C3d7AF4BFA5589d3);
