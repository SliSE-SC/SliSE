...
/**
 * @title Token
 * @dev API interface for interacting with the Defiance Token contract
 */
interface Token {
...
/**
 * @title DefianceSaleVol2
 * @dev DefianceSaleVol2 contract is Ownable
 **/
contract DefianceSaleVol2 is Ownable {
  using SafeMath for uint256;
  Token token;

  uint256 public constant RATE = 1000; // Number of tokens per Ether
  uint256 public constant CAP = 2500; // Cap in Ether
  uint256 public constant START = 1605891600; // Nov 20, 2020 @ 17:00 UTC
  uint256 public constant DAYS = 7; // 7 Day

  uint256 public constant initialTokens = 2500000 * 10**18; // Initial number of tokens available
  ...
  /**
   * DefianceSaleVol2
   * @dev DefianceSaleVol2 constructor
   **/
