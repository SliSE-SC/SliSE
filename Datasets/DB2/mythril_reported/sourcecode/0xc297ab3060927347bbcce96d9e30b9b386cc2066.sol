...
contract WSFDaiVault is Ownable {
    ...
    address public constant trustedRewardTokenAddress = 0x4819a96eB4b22454d628Cd683aE052C2c9076808;
    // reward rate
    ...
    // admin can transfer out reward tokens from this contract five days after vault has ended
    uint public adminCanClaimAfter = 370 days;
    ...
    function getTokenPerDaiUniswap() public view returns (uint) {
    ...
    function updateAccount(address account) private {
        ...
        if (pendingDivs > 0) {
            require(Token(trustedRewardTokenAddress).transfer(account, pendingDivs.mul(getTokenPerDaiUniswap()).div(1e18)), "Could not transfer tokens.");
