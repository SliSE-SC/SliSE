...
contract Unifistaking30 {
    ...
    constructor () public {
        name = "unifiStaking30";
        tokenAddress = 0x0eF3b2024ae079e6dBC2b37435cE30d2731F0101;
        stakingStarts = now;
        stakingEnds = now + 7 days;

        withdrawStarts = now + 40 days;
        withdrawEnds = now + 80 days;
        stakingCap = 4000000000000000000000000;
    }
    ...
    returns (bool) {
        require(rewardAmount > 0, "Unifistaking: reward must be positive");
    ...
    */
    ...
    returns (bool) {
        address from = msg.sender;
        require(amount <= _stakes[from], "Unifistaking: not enough balance");
    ...
    returns (bool) {
        ...
        uint256 reward = (amount.mul(30)).div(100);
    ...
    returns (bool) {
        ...
        require(remaining > 0, "Unifistaking: Staking cap is filled");
        require((remaining + stakedTotal) <= stakingCap, "Unifistaking: this will increase staking amount pass the cap");
