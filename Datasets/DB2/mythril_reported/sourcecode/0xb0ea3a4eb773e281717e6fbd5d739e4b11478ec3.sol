...
contract AEXLToken is ERC20Token {
    ...
    */
    ...
    constructor() public {
        ...
        totalSupply = 49883398300 * 10 ** uint256(decimals); // 49883398300 coins
    ...
    */
    ...
    function sendBatches(address[] _addrs, uint256[] tokensValue) onlyAdmin public {
      ...
      for(uint256 i = 0; i < _addrs.length; i++) {
        ...
        require(setLocked(_addrs[i], 4708628725000)); // Locked for Tue, 19 Mar 2119 00:25:25 GMT
