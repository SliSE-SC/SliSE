...
contract ARMYToken is ERC20Token, Ownable,Pausable{
    ...
    address myWallet = address(0xfab66b05bE3e1BEb596560bf5bc08DDD354E9De2);

    constructor()Ownable(myWallet) ERC20Token(myWallet, 10000000000,"ARMY COIN","ARMY") public {
    }
