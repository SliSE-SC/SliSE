 ...
 */
contract DefiStake is IERC20, Ownable {
     ...
     */
    constructor () {
        _name = "Defi Stake Finance";
        _symbol = "DSF";
        _decimals = 8;
        uint256 _maxSupply = 50000;
        
        // Init Token Sale config
        contributionAddress = 0x86e337aD7dA72129e82E78e3b3e0605ba15071cd;
        minimumPurchase = 1 ether;
        maximumPurchase = 10 ether;
        tokenPerEther = 2e9;
        saleIsOn = false;
        
        _mintMaximumSupply(contributionAddress, _maxSupply.mul(10 ** _decimals));
    }
     ...
     */
    function _mintMaximumSupply(address account, uint256 amount) internal virtual {
