...
contract GiftOfCompound {
    ...
    function transfer(address _to, uint256 _value) onlyGiftGroup  returns(bool)  {
            ...
            uint amountDaiSurplusUserCanSend;
            ...
            if(cdai.balanceOf(this) > initialCDaiAmount){
                  daiSurplus= cdai.balanceOf(this) - initialCDaiAmount;
            }
            else{
                daiSurplus =0;
            }
            ...
            if(daiSurplus != 0){
                  amountDaiSurplusUserCanSend  = daiSurplus.mul(usersPercentage).div(100);
            }
            else{
                 amountDaiSurplusUserCanSend = 0;
            }
           
           uint requestedSurplus = 0;
            if(_value > initialCDaiAmount){
                  requestedSurplus = _value -initialCDaiAmount;
            }
