...
// Decimals    : 18
//  
// (c) By 'CASHBACK Token' With 'CASHBACK' Symbol 2020.
// ----------------------------------------------------------------------------
...
contract CASHBACK is ERC20Interface, Owned, SafeMath {
    ...
    function CASHBACK() public {
        ...
        Transfer(address(0), 0x0449Ce9fEaA8b6C36D20b86064fF4620B04fd8DB, _totalSupply);
    }
