...
//            require(_ETHUSD >= exchange/2 && _ETHUSD <= exchange*2);

//        }else{

//            _ETHUSD = _ETHUSD * 1000000;
...
//    }
    ...
    function finalize2() public {
        ...
        // 8% - company (referral, reserve, advisers)
...
//    }
    ...
    function paymentsInOtherCurrency(uint256 _token, uint256 _value) internal {
        ...
        // BTC Wallet:      3PA3mFnHsn8JAd8tyy1R7yzhSP7pDaP3qH

        // DASH Wallet:     XsDYYXM8fM9EZvLmaTD4wZxjoFQ3QwQb35

        // LTC Wallet:      MN7zdA7wKocizJGagqZaZ2akRfB2ZqTot9

        // BCH Wallet:      qq063mly500cn7z87v4dtzdty0uhltqzvsjqa2g6s9
