...
contract ZODIAC is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function ZODIAC() {
        ...
        name = "ZODIAC";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 8;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ZTC";                                             // Set the symbol for display purposes (CHANGE THIS)
