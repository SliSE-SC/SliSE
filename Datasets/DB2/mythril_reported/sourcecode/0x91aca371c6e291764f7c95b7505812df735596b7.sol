...
contract Presale is Ownable {
    ...
    constructor(
        ...
        TTN = _token;
        USDC = _usdc;
        OWNER = 0x8cCb419C5De3f737b769099A1133364663f32467;
        swaprate = 2200;
    ...
    function receiveFunds(uint256 _amount) public{
        uint256 tokenAmount = _amount.div(swaprate);
        USDC.transferFrom(address(msg.sender), address(this), _amount);
        TTN.approve(msg.sender, _amount);
        TTN.transfer(msg.sender, tokenAmount);
