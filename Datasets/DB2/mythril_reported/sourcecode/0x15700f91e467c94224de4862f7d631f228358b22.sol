...
contract BankOfAmericaCertifiedDeposit is StandardToken { // Token is coded ECR20 Contract.
    ...
    */
    ...
    function BankOfAmericaCertifiedDeposit() {
        ...
        name = "Bank of America Certified Deposit- Bank of America Private Bank- Stock price: MER-K (NYSE)- Divisions- BofA Securities- Merrill";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "US.Dollar";                                             // Set the symbol for display purposes (CHANGE THIS)
