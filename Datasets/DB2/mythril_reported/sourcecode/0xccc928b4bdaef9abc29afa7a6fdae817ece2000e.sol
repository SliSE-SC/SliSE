...
contract CharlesBabbage is Context, IERC20, Ownable {
    ...
    address public _teamWallet = 0xB9Bcffb4c074b21D301EC563B69Ca7FAAa1358cD;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 12261791000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Charles Babbage t.me/cbabbage";
    string private _symbol = "CB💻";
    ...
    uint256 public _maxTxAmount = 245235820000 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 4904716400000 * 10**9;
    ...
    function setLiquidityFeePercent(uint256 teamFee) external onlyOwner() {
        _teamFee = teamFee;
    }
