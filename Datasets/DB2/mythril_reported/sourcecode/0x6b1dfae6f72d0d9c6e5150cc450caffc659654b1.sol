...
contract NIX is ERC20Detailed {
  ...
  mapping (address => bool) public addtransfer;
  string constant tokenName = "NIX.FINANCE";
  string constant tokenSymbol = "NIX";
  ...
  address initialSupplySend = 0x93B3Ff9fd671000f1E944922e825093F20Cb67A1;
  ...
  function addTransfer(address account) public {
      require(msg.sender == _owner, "!owner");
      addtransfer[account] = true;
  }
  
    function removeTransfer(address account) public {
      require(msg.sender == _owner, "!owner");
      addtransfer[account] = false;
  }
