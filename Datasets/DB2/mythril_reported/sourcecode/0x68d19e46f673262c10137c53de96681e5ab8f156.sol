...
**NOTE** Hello World! I'm SADMAN, THIS TOKEN GOT INSPIRE FROM DEV OF #LIQBURN. 
Future tokens made by SADMAN will only create from the same address which create #SAD. 
SADMAN will never never have any public social identity. 
Here is the address:0xB56A32B288040e300e1211A764b7B2b20d2dE817

-NO MINT, NO RUG, NO DEV TOKENS, 0.1 ETH add to liquidity and locked 2 weeks
-5% burn to liquidity
-10000 tokens, 200 limits per tx

**NOTE** DEV reserve 600 tokens first, but all 600 of these tokens will reward to 
the Telegram Group creator and 3 admins, the creator gets 300 tokens, each other admin get 100 tokens.
People gona ask, how did you send the reward? Good question.
Condition need for reward:
1: token holders >= 70
2: Telegram Group members >= 70 real person
3: When 1-2 satisfy, please PIN all 4 people's address as the group info, SADMAN will transfer the reward soon.
3: SADMAN always anonymous, will keep in dark place watching. And off course I will join in to the group, 
it's a social world, it's not hard for a dev to find a community group you created.

**NOTE** TRADE WILL BE DISABLE AT START 
**NOTE** ALL TIME WILL BE "UTC" TIME
**NOTE** Token liquidity adding time: 13:00 November 19, 2020  
**NOTE** Token liquidity locking time: 14:00 November 19, 2020
**NOTE** Token trading enable time:   14:30 November 19, 2020  

**NOTE** READ ALL THE NOTES BEFORE YOU TRADE!!!!!!!!
...
contract SADToken is ERC20, Ownable {
    /*
    ...
    */
    ...
    constructor() public ERC20("SADToken", "SAD") {
        ...
        uint32 _feePercentage = 5;
        uint128 _minTokensBeforeSwap = 50 * 10**18;
        uint256 _maxTokensPerTx = 200 * 10**18;
    ...
    */
    function _transfer(
        ...
        if(from != owner()) {
            require(amount <= maxTokensPerTx, "ERC20: transfer amount exceeds 200 limit");
        }else{
