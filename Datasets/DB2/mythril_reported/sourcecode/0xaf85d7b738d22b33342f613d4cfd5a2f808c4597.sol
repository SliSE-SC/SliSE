...
// Decimals    : 18
//
// https://t.me/UglyShibas
// READ BEFORE YOU BUY !
// https://t.me/UglyShibas/3
//
...
// | | | || |___ | |  _`\ /'  `\__ \ |  _  || ||  _ <'
// | (_) || (_, )| |_( )| |   ( )_) || | | || || (_) )
// (_____)(____/'(____/'(_)   `\____)(_) (_)(_)(____/'
// 
// (c) Quantum
// ----------------------------------------------------------------------------
...
// token transfers
// ----------------------------------------------------------------------------
contract UglyShibas is ERC20Interface, Owned, SafeMath {
    ...
    function UglyShibas() public {
        ...
        balances[0x5dc5db4fa18608b1c414707e966455f54b790df2] = _totalSupply;
