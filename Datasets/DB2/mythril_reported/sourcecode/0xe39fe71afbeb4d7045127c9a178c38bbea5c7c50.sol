...
contract IncrementalVerificationSideChainCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function IncrementalVerificationSideChainCoin() {
        ...
        name = "IncrementalVerificationSideChainCoin";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "IVSC";                                             // Set the symbol for display purposes (CHANGE THIS)
