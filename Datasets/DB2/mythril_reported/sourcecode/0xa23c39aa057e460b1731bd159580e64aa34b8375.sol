 ...
 *KamaCash  Tokenomics 💰 
*- 27% Burn FOREVER
*- 30% TOKENS FOR Presale
*- 35% TOKEN FOR UNISWAP Uniswap
*- 5% Team and Marketing
*- 2% KamaCash  App development
*- 1% NFT Development and Airdrops


8% Fee Buy & Sell (16% Round trip)
2% Liq. Pool
3% Will go towards Marketing, Development and Rapid Project Implementation
3% Will be Rewarded to all Holders


my thrives on Volume and the longer and more you hold, the faster you accumulate tokens. *Always be Shilling*
 *
 *Total Supply 1,000,000,000,000
 *
 *Liquidity Locked for 100 Years - 10 ETH Initial Pair
 *
 *Max Tx Limit set to 0.5% - Dump Proof - Whale Proof - Rug Proof

 *Fully Doxed Team with complete Transparency
 *
 *"We want to utilize every dollar for the community in order to better our communities lives and provide Safe Homes in case shit hits the fan... 
 *So we don't believe in sending massive amounts of $$$ to Burn Addresses. Together we can build something amazing, let's put our money to good use!"
 */
...
contract Ownable is Context {
    ...
    constructor() internal {
        ...
        _owner = 0xd07293135C16F7A8C4da5F60c3bE0C68B75E669F;
...
contract KamaCash is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "KamaCash";
    string private _symbol = "KCASH";
    ...
    uint256 public _taxFee = 3; // means 3% to all holders
    uint256 public _liquidityFee = 0; // means 0% auto LP
    uint256 public _burnFee = 3; // means 3% burn
    uint256 public devFee = 400; // start at 89% to avoid early buys, -15% Purchase- set isFeeActive = true at same time as Initial Pairing, change to 400 means 4% to Dev wallet
    
    address devAddress = 0xd07293135C16F7A8C4da5F60c3bE0C68B75E669F; //
    
    uint256 public _taxFeeTotal;
    uint256 public _burnFeeTotal;
    uint256 public _liquidityFeeTotal;

    bool public isFeeActive = false; // launch as false to avoid tokenommics for transfers, change to true after Initial Pair - owner wallet buys 15% @ .69 and .236 ETH @ 80% vs 4 ETH
    bool private inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    
    uint256 public maxTxAmount = 1000000000000e18; // 100% of total supply limit, change to 5000000000000000000000000000 after Initial Pairing for 0.5% max sell
