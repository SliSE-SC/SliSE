...
contract RTTeacherToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function RTTeacherToken() {
        ...
        name = "RTTeacherToken";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "RTT";                                             // Set the symbol for display purposes (CHANGE THIS)
