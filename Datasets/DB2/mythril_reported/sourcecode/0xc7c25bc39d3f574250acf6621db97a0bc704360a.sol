...
// (c) Test Bond Contract #1. MGLFOREX
...
contract Tbond1 is ERC20Interface, Owned, SafeMath {
    ...
    uint public HARD_CAP_T = 1000000;
    ...
    function Tbond1() public {
        ...
        bonusEnds = now + 10000000000000000 days;

        endDate = now + 10000000000000000 days;

        endCrowdsale = 1000000e3;
