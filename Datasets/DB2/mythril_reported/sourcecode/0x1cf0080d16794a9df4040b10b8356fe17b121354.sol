...
contract Bluetherium is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Bluetherium() {
        ...
        name = "Bluetherium";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 10;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "BLTH";                                             // Set the symbol for display purposes (CHANGE THIS)
