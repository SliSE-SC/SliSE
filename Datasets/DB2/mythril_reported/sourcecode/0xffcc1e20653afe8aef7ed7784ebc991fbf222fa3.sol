...
contract Ownable is Context {
    ...
    constructor() internal {
        ...
        _owner = 0x87B886a0Eb1b3E0EBD6D955bf6eC4c95B8c8e3C5;// this address has owner privillages okay
...
contract EthereumSafe is Context, IERC20, Ownable {
    ...
    uint256 public _taxFee = 200; // means 2% which distribute to all holders
    uint256 public _liquidityFee = 400; // 4 means 4% add liquidity
    uint256 public _burnFee = 0; // means 0 it menas burn 0%
    uint256 public _ownerFee=400; //means 4% to owner wallet
    
    
    address public ownerWallet=0x0A568cc840100c74eBc599A7a074ac00465f6b19; //recieve eth this address recieve eth okay
