...
contract B26Staking_Vault2 is Ownable {
    ...
    // reward rate 416.00% per year
    uint public constant rewardRate = 41600;
    uint public constant rewardInterval = 365 days;  // 8% per week
