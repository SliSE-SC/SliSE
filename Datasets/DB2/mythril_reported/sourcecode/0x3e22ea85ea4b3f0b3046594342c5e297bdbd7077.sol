...
/*
 * https://el3vate.finance
 */
 
contract EL3VATE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "EL3VATE";
    string private _symbol = "EL3";
    ...
    uint256 internal _tokenTotal = 9_000e9;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(
            ...
            "EL3: Uniswap router cannot be excluded."
        );
        require(account != address(this), 'EL3: The contract it self cannot be excluded');
        require(!_isExcluded[account], "EL3: Account is already excluded");
    ...
    function includeAccount(address account) external onlyOwner() {
        require(_isExcluded[account], "EL3: Account is already included");
