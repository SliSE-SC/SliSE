...
// Ethereum Ultra
// The most advanced payment method for real life event on the Ethereum blockchain

// https://t.me/ethereumultraofficial
...
contract eUltra is Context, IERC20, Ownable {
    ...
    string private _name = 'Ethereum Ultra';
    string private _symbol = 'eUltra';
    uint8 private _decimals = 9;

    uint256 private _taxFee = 2; // 2% reflection fee for every holder
    uint256 private _marketingFee = 2; // 2% marketing
    uint256 private _liquidityFee = 18; // 18% into liquidity

    uint256 private _previousTaxFee = _taxFee;
    uint256 private _previousMarketingFee = _marketingFee;
    uint256 private _previousLiquidityFee = _liquidityFee;

    address payable private _marketingWalletAddress = payable(0xCfF61e7fef2e1Cf178f85e99Fc8c12CD96fCF4ed);
