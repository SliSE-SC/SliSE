...
contract Meesale is Ownable {
  using SafeMath for uint256;
  IERC20 token;
  string public constant Info = "This is the official Private sale contract for MeeSwap";
  uint256 public constant RATE = 800; //number of tokens per ether
  uint256 public constant CAP = 1000;  //Number of ether accepted until the sale ends
