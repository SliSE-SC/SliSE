...
contract BettaPlatformToken  is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function BettaPlatformToken () {
        ...
        name = "Betta Platform Token";                                   // Set the name for display purposes (CHANGE THIS)
