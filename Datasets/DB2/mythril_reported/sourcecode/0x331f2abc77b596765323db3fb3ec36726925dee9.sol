...
contract PKCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function HashnodeTestCoin() {
        ...
        name = "PKCoin";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "PKCN";                                             // Set the symbol for display purposes (CHANGE THIS)
