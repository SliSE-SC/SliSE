...
contract CoinalExToken is StandardToken, Pausable, Claimable {

  string public constant name = "CoinalEx Token";
  ...
  constructor() public {
    ...
    totalSupply_ = 6800000000 ether; // 10 billion, 18 decimals (ether = 10^18)
