...
contract CCXTokenERC20 {
    ...
    string public constant _myTokeName = 'Mooneta';//change here

    string public constant _mySymbol = 'MNTX';//change here

    uint public constant _myinitialSupply = 10000000000;//leave it
