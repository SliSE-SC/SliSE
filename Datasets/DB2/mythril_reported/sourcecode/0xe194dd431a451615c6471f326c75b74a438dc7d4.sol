...
contract Aironetwork is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    string public symbol;                 // An identifier: eg BTC, XPR etc..
    ...
    function Aironetwork() {
        ...
        name = "AIRO NETWORK";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "AIRO";                                             // Set the symbol for display purposes (CHANGE THIS)
