...
// Used contracts
//Internal
contract ExchangeHUSDC is Ownable, ReentrancyGuard {
	using SafeMath for uint256;
	...
	*/
    ...
    /** 
    * @dev Burns In Tokens
    * @param _amount - In Token units
    */
    function burnInTokens (
        uint256 _amount
    )
        public
        onlyOwner
    ...
    */
    function getInTokenBalance()
        ...
        returns (uint256)
    {
        return inToken.balanceOf(address(this));
    }
