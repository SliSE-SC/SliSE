...
/*  
    Merkle Network : https://merkle.network
    Symbol: MERKLE
    Decimals: 18                    
*/
...
contract MerkleNetworkERC20 is ERC20, Verify, Ownable {
    using SafeMath for uint256;
    
    constructor()
    public
    ERC20("Merkle Network Token", "MERKLE")
    {
        uint8 decimals_ = 18;
        uint256 supply_ = 60000000 * 10**uint256(decimals_);
