...
//PreSale Contract For various tokens. 
...
contract IYRPresale is Ownable {
  ...
  function withdraw(address payable to) public onlyOwner {
    if (presaleStock() > 0) {
      IYR(tokenAddress).transfer(address(to), presaleStock());
    }
