...
contract TimeLock is Ownable{
  ...
  ERC20 private hudlToken;
  uint256 private claimedWeeks = 0;
  uint256 private weeklyUnlock = 9615 * 10**18;

  constructor(uint256 _startTime, address _tokenAddress, address _beneficiary) public{
    startTime = _startTime;
    hudlToken = ERC20(_tokenAddress);
  ...
  function unlock() public {
    ...
    require(weeksClaimable >= 1, "Need to wait at least 1 week before claiming again");
    uint256 newAmount = 0;
