...
contract INAExchangeToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function INAExchangeToken() {
        ...
        name = "INAExchangeToken";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "INA";                                             // Set the symbol for display purposes (CHANGE THIS)
