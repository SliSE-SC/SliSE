...
contract FKEmax is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100 * 38259683629 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "FKEmax";
    string private _symbol = "FKEmax";
