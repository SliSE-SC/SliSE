...
/* ----------------------------------------------------------------------------
Fengzhi Liquor Industry has the right to final interpretation and reserves the right to modify with all issued Lao Shi Jiu (LSJ).

For the latest revision of the operating policies and trading models of LSJ, please refer to the official announcements on the website (http://www.bitcaps.club/lsj). The website has the final interpretation and reserves all rights to modify, to insert, and/or to withdraw any parts with the announcements.
---------------------------------------------------------------------------- */
...
// ----------------------------------------------------------------------------
contract LaoShiJiu is ERC20Interface, Owned {
...
// ----------------------------------------------------------------------------
    string public constant symbol = "LSJ";
    string public constant name = "Lao Shi Jiu";
	...
	string public constant website = "http://www.laoshijiu.com";
