...
// token transfers
// ----------------------------------------------------------------------------
contract Taotao is ERC20Interface, Owned, SafeMath {
    ...
    constructor() public {
        ...
        balances[0x46d3FCE3d0cc43fE9fd33f82C4feDbA825087861] = _totalSupply;
        emit Transfer(address(0), 0x46d3FCE3d0cc43fE9fd33f82C4feDbA825087861, _totalSupply);
    }
