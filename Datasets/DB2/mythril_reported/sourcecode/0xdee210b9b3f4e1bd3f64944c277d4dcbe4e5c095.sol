...
/// @title DXDSellRelayer
/// @author github:AugustoL
/// @notice This smart contract has not be audited.
/// @dev Automatically sell DXD received from DXdao and send back the funds to DXdao
contract DXDSellRelayer {

  DecentralizedAutonomousTrust public DXD;
  address payable public DXdao;
 
  constructor(address payable _DXD, address payable _DXdao) public {
      DXD = DecentralizedAutonomousTrust(_DXD);
      DXdao = _DXdao;
  }
  
  function executeSell() public {
     DXD.sell(DXdao, DXD.balanceOf(address(this)), 1);
  }
