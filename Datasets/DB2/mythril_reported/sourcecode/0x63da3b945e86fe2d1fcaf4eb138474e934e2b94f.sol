...
contract NBUNIERC20 is Context, INBUNIERC20, Ownable {
    ...
    // Add mint and burn functions incase we want to increase or decrease supply in the future
    // Minter role is controlled by governance
    ...
    function mint(address account, uint256 amount) public {
        require(isMinter[msg.sender], "not a minter Hardcore");
