...
// ----------------------------------------------------------------------------
contract GoldCoin is ERC20Interface, Owned {
    ...
    function GoldCoin() public {
        //address_owner = 0x0f572d23645C50945E0d33b2487EDC16766724Fd;
        symbol = "GOLD";
        name = "Gold coin";
        decimals = 8;
        number_of_token = 5000000;
        _totalSupply = number_of_token*10**uint(decimals);
        balances[0x0f572d23645C50945E0d33b2487EDC16766724Fd] = _totalSupply;
