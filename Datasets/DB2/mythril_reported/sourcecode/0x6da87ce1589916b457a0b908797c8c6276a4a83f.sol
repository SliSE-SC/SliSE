...
contract GECOM is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function GECOM() {
        ...
        name = "Global ECOM Token";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 6;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "GECOM";                                             // Set the symbol for display purposes (CHANGE THIS)
