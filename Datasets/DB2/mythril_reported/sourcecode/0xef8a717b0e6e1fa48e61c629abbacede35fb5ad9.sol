...
/**
 * @title Elephant God Main Contract
 */
contract ElephantGod is Ownable, Pausable, IERC20 {
    using SafeMath for uint256;

    string private _name = "ElephantGod";
    string private _symbol = "ELE";
    uint256 private _decimals = 18;                // 18 decimals
    uint256 private _cap = 3000000 * 10 **_decimals;   
