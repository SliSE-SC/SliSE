...
// File: contracts/DOTA.sol



contract DOTA is StandardToken, Pausable, Claimable {

  string public constant name = "DOT Access";

  string public constant symbol = "DOTA";
  ...
  constructor() public {
    ...
    totalSupply_ = 88000000 ether; // 88 million, 18 decimals (ether = 1^9)
