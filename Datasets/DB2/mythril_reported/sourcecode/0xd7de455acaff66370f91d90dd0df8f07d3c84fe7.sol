 ...
 * Source Code first verified at https://etherscan.io on Friday, March 8, 2019
...
contract PenniHungary is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function PenniHungary() {
        ...
        totalSupply =          99999999999999999999999999999;                        // Update total supply (1000 for example) (CHANGE THIS)

        name = "PenniHungary";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 2;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "PHU";                                             // Set the symbol for display purposes (CHANGE THIS)
