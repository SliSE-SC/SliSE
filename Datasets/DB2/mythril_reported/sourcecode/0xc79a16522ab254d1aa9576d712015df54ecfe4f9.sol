...
contract WSBCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function WSBCoin() {
        ...
        name = "WallStreetBets";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 4;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "WSB";                                             // Set the symbol for display purposes (CHANGE THIS)
