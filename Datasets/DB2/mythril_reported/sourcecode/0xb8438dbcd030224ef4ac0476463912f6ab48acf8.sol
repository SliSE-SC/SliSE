...
contract UniDappStacking is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    // UniDappStacking token contract address
    address public constant tokenAddress = 0xe27E62D953Aa17ac0C63f9B091C5474C608b4E54;
    
    // reward rate 456.25% per year
    uint public constant rewardRate = 45625;
    ...
    // Project Staking upto 20,000 UniDapp     // 18 Decimals
