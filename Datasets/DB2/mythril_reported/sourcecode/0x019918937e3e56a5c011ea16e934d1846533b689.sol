 ...
 * functions, this simplifies the implementation of "user permissions". Modified from Open
...
contract AudioToken is ERC20Detailed, Ownable {
    ...
    */
    ...
    function recoverTokens(address _token, uint256 _value) onlyOwner public returns (bool) {
