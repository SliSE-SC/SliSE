...
//make sure this function name matches the contract name above. So if you're token is called TutorialToken, make sure the //contract name above is also TutorialToken instead of ERC20Token
    ...
    function ERC20Token(
        ...
        balances[msg.sender] = 70000000000;               // Give the creator all initial tokens (100000 for example)
        totalSupply = 70000000000;                        // Update total supply (100000 for example)
        name = "WC Paper Coin";                                   // Set the name for display purposes
        decimals = 3;                            // Amount of decimals
        symbol = "WPAC";                               // Set the symbol for display purposes
    }
