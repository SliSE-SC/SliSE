...
0.1 ETH = 500,000 + 25% Bonus

1 ETH = 5,000,000 + 50% Bonus
...
contract BEXAM is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function BEXAM() {
        ...
        name = "BEXAM";                                   // Set the name for display purposes (CHANGE THIS)
