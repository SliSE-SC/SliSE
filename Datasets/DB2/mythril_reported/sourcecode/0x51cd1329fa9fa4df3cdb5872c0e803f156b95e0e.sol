...
contract Denar is StandardToken { // CHANGE THIS. Update the contract name.
   ...
   */
    ...
    function Denar() {
        ...
        totalSupply = 10000000000000000;                        // Update total supply (1000 for example) (Denar )

        name = "Denar";                                   // Set the name for display purposes Denar

        decimals = 8;                                               // Amount of decimals for display purposes (Denar)

        symbol = "DAR";                                             // Set the symbol for display purposes Denar

                                              // Set the price of your token for the ICO Denar

        fundsWallet = msg.sender;                                    // The owner of the contract gets ETH Denar
