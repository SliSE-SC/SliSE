...
contract DogeCoinStaking is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    // DogeCOin Cash Token contract address
    address public constant tokenAddress = 0xb91b9AE0C65c7B3f066F5E92db0156aF2DEcFA92;
    ...
    // unstaking possible after 168 hours
    uint public constant cliffTime = 168 hours;
    ...
    uint private constant stakingAndDaoTokens = 1000000000e18;   // 1,000,000,000 DogeCoin Cash will be staked by owner
