...
contract StandardToken is Token {
 ...
 contract PundiXClassic is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function PundiXClassic() {
        ...
        name = "Pundi X Classic";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 2;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "NPXC";                                             // Set the symbol for display purposes (CHANGE THIS)
