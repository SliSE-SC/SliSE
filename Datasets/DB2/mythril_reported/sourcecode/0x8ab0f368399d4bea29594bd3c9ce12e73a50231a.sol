...
contract ScoobySnacks is Context, IERC20, Ownable {
    ...
    string private _name = 'Scooby Snacks';
    string private _symbol = 'SCOOBYSNAX';
    ...
    uint256 private _taxFee = 0; // 0% reflection fee for every holder because no need (Ruh roh!)
    uint256 private _projectDevelopmentFee = 10; // 10% project development for snacks
    uint256 private _previousTaxFee = _taxFee;
    uint256 private _previousProjectDevelopmentFee = _projectDevelopmentFee;

    address payable public _projectDevelopmentWalletAddress = payable(0x17079784A0faa218c2D4ae9d278F5E0fBa376106);
