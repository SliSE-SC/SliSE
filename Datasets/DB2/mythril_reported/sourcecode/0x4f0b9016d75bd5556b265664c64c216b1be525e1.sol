...
contract LPTokenWrapper {
    ...
    IERC20 public y = IERC20(0xf275E8785Cc7C9325B088DC804cF2bab11a09825);
...
contract RGRewardECPool is LPTokenWrapper, IRewardDistributionRecipient {

    address public developer;

    bool isInit = true;

    IERC20 public yieldToken = IERC20(0x54091956C7d7b2E0fCD669D41dC8e41d464CbD76);

    uint256 public constant DURATION = 10 days;

    // init 100, total 400. 50% reduction in production every 10 days
    uint256 public initreward = 100 * 1e18;
    uint256 public starttime = 1602849600;
