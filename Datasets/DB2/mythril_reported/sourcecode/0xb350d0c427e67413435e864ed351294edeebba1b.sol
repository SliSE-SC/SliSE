...
contract BNIBankNegaraIndonesia is StandardToken { // Token is coded ECR20 Contract.
    ...
    */
    ...
    function BNIBankNegaraIndonesia() {
        ...
        name = "BNI Bank Negara Indonesia  Certified Deposit-PT Bank Mandiri Tbk-Subsidiaries: PT. Bank BNI Syariah, PT BNI Life Insurance";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "IDR.IndonesianRupiah";                                             // Set the symbol for display purposes (CHANGE THIS)
