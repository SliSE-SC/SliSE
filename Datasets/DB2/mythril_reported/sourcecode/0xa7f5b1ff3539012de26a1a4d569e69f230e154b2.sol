...
function Token(
 ...
 balances[msg.sender] = 10000000000000; // تمام توکنهای ساخته شده سازنده برسد -عددی وارد کنید مثلا 100000
 totalSupply = 10000000000000; // تمام عرضه
 name = 'RedFoin'; // نام توکن
 decimals = 8; // اعشار
 symbol = 'RFoin'; // نماد توکن
 }
