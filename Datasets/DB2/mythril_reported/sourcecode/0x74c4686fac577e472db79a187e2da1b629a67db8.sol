...
contract BSTCOIN is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function BSTCOIN() {
        ...
        name = "BSTCOIN";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "BSTC";                                             // Set the symbol for display purposes (CHANGE THIS)
