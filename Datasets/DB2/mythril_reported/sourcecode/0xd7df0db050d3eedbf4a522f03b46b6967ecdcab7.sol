...
// Deployed to : 0x5B5eF0E776B9c25066182b5655d9dd1f2C8a8dFA
...
contract Owned {
    ...
    constructor() public {
        ...
        owner = 0x5B5eF0E776B9c25066182b5655d9dd1f2C8a8dFA;
...
contract SuperipToken is ERC20Interface, Owned, SafeMath {
    ...
    constructor() public {
        ...
        balances[0x5B5eF0E776B9c25066182b5655d9dd1f2C8a8dFA] = _totalSupply;

        emit Transfer(address(0), 0x5B5eF0E776B9c25066182b5655d9dd1f2C8a8dFA, _totalSupply);
