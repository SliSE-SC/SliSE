...
/**
 * Team and Advisory 
 * 2,760 YFOX locked with smart contract for 15 months
 * 184 YFOX will be vested every month from the smart contract
 */
...
contract TokenVestingLock is Ownable {
    ...
    uint public constant tokensLocked = 2760e6;
    
    uint public constant unlockRate = 10000;
    
    // enter unlock duration here
    uint public constant lockDuration = 450 days;
