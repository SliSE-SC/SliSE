 ...
 *Donation for Listed Exchange and Verified CoinMarketCap

 * 

 * 1 Ether balance contract already listed Exchange

 * 2 Ether blance contract already listed coinmarketcap and binance
...
contract ZeroGold is ERC20 {
    ...
    string public constant name = "ZeroGold";

    string public constant symbol = "0GOLD";
    ...
    uint256 public totalDistributed = 20000000000e8;
