...
contract GodcoinERC20 {
    string public constant _myTokeName = 'Godcoin Token';
    string public constant _mySymbol = 'GDC';
...
contract MyAdvancedToken is owned,GodcoinERC20 {
    ...
    function MyAdvancedToken(
        ...
        string tokenName,
        string tokenSymbol
    ) GodcoinERC20(initialSupply, tokenName, tokenSymbol) public {}
