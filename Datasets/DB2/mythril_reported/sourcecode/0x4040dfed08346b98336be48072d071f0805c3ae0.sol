...
contract DITECHCOIN is owned, TokenERC20 {
    ...
    uint256 public sellPrice; // 100e8 1ETH = 100 DTC
    uint256 public buyPrice; // 100e8 1ETH = 100 DTC
    bool isAllowMining;
    uint256 public minBalanceForAccounts; // 6 finney
