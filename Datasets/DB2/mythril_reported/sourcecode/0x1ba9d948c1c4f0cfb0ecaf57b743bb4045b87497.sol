...
// File interfaces/badger/IPausable.sol
...
// File contracts/badger-timelock/Executor.sol

pragma solidity >=0.5.0 <0.7.0;


contract Executor {
    function execute(address to, uint256 value, bytes memory data, uint256 operation, uint256 txGas)
        internal
...
// File contracts/badger-core/GatedProxy.sol
