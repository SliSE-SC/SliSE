...
// File: contracts/bdayCardNFT.sol
...
contract BirthDayCard is ERC721, ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    mapping(uint256 => string) private tokenURIMap;
    
    constructor() ERC721("Birthday Card", "BDYC") {}

    function safeMint(address to, string calldata uri) public onlyOwner {
        _safeMint(to, _tokenIdCounter.current());
        tokenURIMap[_tokenIdCounter.current()] = uri;
