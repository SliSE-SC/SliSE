...
contract DNBASACertifiedDepositSubsidiaries is StandardToken { // Token is coded ECR20 Contract.
    ...
    */
    ...
    function DNBASACertifiedDepositSubsidiaries() {
        ...
        name = "DNB ASA Certified Deposit - Subsidiaries: Cresco, Vital Forsikring, DnB NORD, Nille AS -Stock price: DNBHF (OTCMKTS)";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "NOK.NorwegianKrone";                                             // Set the symbol for display purposes (CHANGE THIS)
