...
/*
    We are engaging in a form of entertainment known as Trading Entertainment. This is a game where elite competitors apply their strategy to win.

    We are NOT creating currency, securities, coins, or any form of investment. The code of our tokens state this explicitly.

    The tokens we create are pieces that enable the game to be played.

    Tokens have a minimum of 3 days to be traded. Some exceptions may extend the time allowed on the tokens. 

    We are not giving investment or financial advice. Know the risk associated with this game and how these particular tokens will be played.
...
contract BlackGoku is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    using SafeCast for int256;
  
    string private _name = "Black Goku Inu | https://t.me/GladiatorTrading";
    string private _symbol = "BlackGoku";
    ...
    constructor() public {
        ...
        buyBackAddress = 0xaD389cc346e84Ad5c0FcF20Aaa279f5cb0326599;
