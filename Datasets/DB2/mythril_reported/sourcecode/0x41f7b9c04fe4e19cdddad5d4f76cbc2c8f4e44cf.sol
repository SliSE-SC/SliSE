...
contract RoadDrop is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function RoadDrop() {
        ...
        name = "RoadDrop";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "RDX";                                             // Set the symbol for display purposes (CHANGE THIS)
