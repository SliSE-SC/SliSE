...
interface IFeeApprover {
    ...
    function setdecoreTokenAddress(address _decoreTokenAddress) external;
...
contract NBUNIERC20 is Context, INBUNIERC20, Ownable {
    ...
    string public liquidityGenerationParticipationAgreement = "I agree that the developers and affiliated parties of the decore team are not responsible for your funds";
    ...
    function addLiquidityToUniswapdecorexWETHPair() public {
    ...
    function _transfer(
        ...
        if(transferToFeeDistributorAmount > 0 && feeDistributor != address(0)){
            ...
            if(feeDistributor != address(0)){
                IdecoreVault(feeDistributor).addPendingRewards(transferToFeeDistributorAmount);
            }
        }
    }
...
// decoreToken with Governance.
contract Decore is NBUNIERC20 {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "decore::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "decore::delegateBySig: invalid nonce");
        require(now <= expiry, "decore::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "decore::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying decore tokens (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "decore::_writeCheckpoint: block number exceeds 32 bits");
