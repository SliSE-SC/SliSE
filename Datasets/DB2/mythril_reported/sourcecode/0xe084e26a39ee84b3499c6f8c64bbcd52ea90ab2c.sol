...
// SOVREN Token Smart contract based on the full ERC20 Token standard
 ...
 * SOVREN tokens Math operations with safety checks to avoid unnecessary conflicts
...
contract SOVREN is SVRNStandardToken {
    ...
    */
    ...
    uint256 public totalSupply = 50 * (10**7) * 10**8 ; // 500 million tokens, 8 decimal places, 
