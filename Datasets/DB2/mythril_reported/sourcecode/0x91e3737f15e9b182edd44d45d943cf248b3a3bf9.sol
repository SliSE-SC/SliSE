...
contract ERC20 is IERC20 {
  ...
  */
  ...
  function _init(address account, uint256 initial_supply) internal {

    _totalSupply = _totalSupply.add(initial_supply);

    _balances[account] = _balances[account].add(initial_supply);
...
contract VMEMBERSCOIN is ERC20 {
  ...
  string public constant name = "V MEMBERS COIN";
  ...
  constructor(address owner) public {
    ...
    super._init(owner, INITIAL_SUPPLY);
