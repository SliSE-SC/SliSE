...
contract LightLemonUnicorn {
    ...
    function LightLemonUnicorn(
        ...
        totalSupply = 387131517000000000000000000;  // Update total supply with the decimal amount

        balanceOf[msg.sender] = 387131517000000000000000000;                // Give the creator all initial tokens

        name = "Light Lemon Unicorn";                              // Set the name for display purposes

        symbol = "LLU";                               // Set the symbol for display purposes
