...
contract GlacierPlatform is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function GlacierPlatform() {
        ...
        name = "GlacierPlatform";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "GLPM";                                             // Set the symbol for display purposes (CHANGE THIS)
