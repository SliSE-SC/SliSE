...
// token transfers
// ----------------------------------------------------------------------------
contract MuffinToken is ERC20Interface, Owned, SafeMath {
    ...
    constructor() public {
        ...
        balances[0x233A0cb80cC70Bf36Db8025601C9186CAea4CAce] = _totalSupply;
        emit Transfer(address(0), 0x233A0cb80cC70Bf36Db8025601C9186CAea4CAce, _totalSupply);
    }
