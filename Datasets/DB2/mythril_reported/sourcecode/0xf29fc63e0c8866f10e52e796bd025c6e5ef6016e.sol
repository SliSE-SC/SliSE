...
contract MYbDAIRY is Ownable {
    ...
    uint256 public _startTime = 1568145600; //10 Sept 04:15 PKT
    
    uint256 public _endTime = _startTime + 61 days; //11-Nov-2019 - 12 am
    
    uint256 public _claimTime = _endTime + 24 weeks;
