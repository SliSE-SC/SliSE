...
contract NetExchange is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function NetExchange() {
        ...
        totalSupply = 900000000000000000000000000;                        // Update total supply (1000 for example) (CHANGE THIS)

        name = "NetExchange";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "NEX";                                             // Set the symbol for display purposes (CHANGE THIS)
