...
contract Cadin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Cadin() {
        ...
        name = "Cadin";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "CDN";                                             // Set the symbol for display purposes (CHANGE THIS)

        unitsOneEthCanBuy = 1000000000000;                                      // Set the price of your token for the ICO (CHANGE THIS)
