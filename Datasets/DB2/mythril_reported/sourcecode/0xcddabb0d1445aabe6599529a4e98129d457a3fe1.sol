...
// BLACKDOLLAR Token contract based on the full ERC 20 Token standard
// Symbol: BDLR
// Status: ERC20 Verified

contract BLACKDOLLARToken { 
...
/**
 * BLACKDOLLARToken Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract BdlrStandardToken is BLACKDOLLARToken, Ownable {
    
    using BDLRMaths for uint256;
...
contract BLACKDOLLAR is BdlrStandardToken {
    ...
    */
    ...
    uint256 public totalSupply = 11 * (10**7) * 10**8 ; // 110 million tokens, 8 decimal places
    string constant public name = "BLACK DOLLAR"; //fancy name: eg Black Dollar
    string constant public symbol = "BDLR"; //An identifier: eg BDLR
