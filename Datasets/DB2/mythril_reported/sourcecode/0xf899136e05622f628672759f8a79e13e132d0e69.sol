...
contract DBanX2 is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function DBanX2() {
        ...
        name = "DBanX2";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "DB2";                                             // Set the symbol for display purposes (CHANGE THIS)
