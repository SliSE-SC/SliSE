...
contract OxShelterEye is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function OxShelterEye() {
        ...
        name = "OxShelterEye";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "OxSE";                                             // Set the symbol for display purposes (CHANGE THIS)
