...
contract Token {
    ...
    /* DELITALY "DLIT" - the utility token for GourmetChain.it - Italian Food certified */
...
contract DELITALYToken is StandardToken {
    ...
    function DELITALYToken(
        ...
        name = "DELITALY";                                // Set the name for display purposes
        decimals = 2;                                     // Amount of decimals for display purposes
        symbol = "DLIT";                                  // Set the symbol for display purposes
    }
