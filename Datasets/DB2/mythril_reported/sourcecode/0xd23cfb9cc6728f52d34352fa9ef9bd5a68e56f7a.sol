...
contract SKUREX {
    ...
    constructor(
        ...
        balanceOf[msg.sender] ;                // Give the creator all initial tokens

        name = tokenName="SKUREX";                                   // Set the name for display purposes

        symbol = tokenSymbol="SKUREX";                               // Set the symbol for display purposes
