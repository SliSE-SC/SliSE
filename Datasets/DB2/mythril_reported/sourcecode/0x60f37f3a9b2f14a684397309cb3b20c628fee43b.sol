...
/*
 * BittrexOpenSourceClone (BOSC)
 * A Token meant to fund the cloning of Bittrex Exchange
 * With Spring Boot V2 MVC on the back end for SOA services
 * and Angular JS 2 on the front end
 */
...
contract BittrexOpenSourceClone {
     ...
     */
    function BittrexOpenSourceClone(
    ) public {
