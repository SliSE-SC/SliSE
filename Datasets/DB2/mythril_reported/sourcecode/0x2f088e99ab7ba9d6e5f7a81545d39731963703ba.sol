...
contract AsiaTripper is StandardToken {

    function AsiaTripper() public { 
    ...
    */
    string public name = "AsiaTripper";
    string public symbol = "PSY";
    uint public decimals = 8;
    uint public INITIAL_SUPPLY = 420 * (10 ** decimals);
    string public Image_root = "";
    string public Note_root = "";
    string public DigestCode_root = "0c9d779e9d94e4a4ba9aa1c464c8f03c605286a3b68e0766ec2155fbb2a2378b";
    function getIssuer() public view returns(string) { return  "null"; }
    function getArtist() public view returns(string) { return  "https://swarm-gateways.net/bzz:/54718bd77664b21186ff7f7ce792a72c221492c3e3539d9b490f26d8393b4357/"; }
