...
contract YFMX is ERC20Detailed {
  ...
  string constant tokenSymbol = "YFMX";
  uint8  constant tokenDecimals = 18;
  uint256 _totalSupply = 15000*10**uint(tokenDecimals); 
  ...
  address initialSupplySend = 0xFbd4473cb89c5e6adB6FaC3705F1A9Ce933DdCdB;
