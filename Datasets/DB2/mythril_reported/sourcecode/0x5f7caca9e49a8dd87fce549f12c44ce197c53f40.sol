...
Token Information
1. 420,690,000,000,000 Total Supply
3. We're going to the moon. 

Telegram: t.me/area69
Twitter: https://area69.space
*/
...
contract EthereumPro is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 420_690_000_000_000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = 'Area 69';
    string private _symbol = 'AREA69';
    uint8 private _decimals = 9;

    uint256 private _taxFee = 1; // 4% reflection fee for every holder
    ...
    address payable private _marketingWalletAddress = payable(0xA9368D29bF6A95962BFF99864820B82B4097E936);
