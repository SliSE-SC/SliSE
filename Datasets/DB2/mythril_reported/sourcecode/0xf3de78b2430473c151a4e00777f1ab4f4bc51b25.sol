...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/solc-0.6/contracts/utils/Context.sol
...
contract AdvisoryReserves is Ownable {
    ...
    /// @notice dmod token address
    address public immutable dmodToken;

    /// @notice identifier for the contract
    string public identifier;

    /**
     * @notice Construct a new Reserve Contract
     * @param _dmodToken dmod token address
     */
    ...
    function transferTokensToAddress(address receiver, uint amount) external onlyOwner {
        ...
        IERC20 dmodTokenInstance = IERC20(dmodToken);
        dmodTokenInstance.transfer(receiver, amount);
