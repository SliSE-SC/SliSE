...
contract CommonwealthBankCertifiedDepositAustralia is StandardToken { // Token is coded ECR20 Contract.
    ...
    */
    ...
    function CommonwealthBankCertifiedDepositAustralia() {
        ...
        name = "Commonwealth Bank Certified Deposit - The Commonwealth Bank of Australia - Subsidiaries: Bankwest, Commonwealth Securities";                                  // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "AUD.AustralianDollar";                                             // Set the symbol for display purposes (CHANGE THIS)
