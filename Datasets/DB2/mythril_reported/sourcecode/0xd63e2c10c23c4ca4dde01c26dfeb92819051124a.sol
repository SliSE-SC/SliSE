...
string public name = "HoNamBrewing";
string public symbol = 'HNB';
...
name = "HoNamBrewing"; // Set the name for display purposes
symbol = "HNB"; // Set the symbol for display purposes
}
...
contract HNB is owned, TokenERC20 {
