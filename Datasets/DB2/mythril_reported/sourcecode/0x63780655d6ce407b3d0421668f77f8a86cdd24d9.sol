...
contract EqFinanceStaking is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    // EqFinance token contract address
    address public constant tokenAddress = 0xD9Dd37ee6523e6Cc0Dbcc723018D2C93408feE6b;
    
    // reward rate 365.00% per year
    uint public constant rewardRate = 36500;
    uint public constant rewardInterval = 365 days;     // 7% per week
    ...
    uint private constant stakingAndDaoTokens = 3000000e18;   // 3,000,000 EQFi will be staked by owner
