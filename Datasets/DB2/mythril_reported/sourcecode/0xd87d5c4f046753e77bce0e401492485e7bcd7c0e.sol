...
contract HealthInsurance is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function HealthInsurance() {
        ...
        name = "Health Insurance";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "HIS";                                             // Set the symbol for display purposes (CHANGE THIS)
