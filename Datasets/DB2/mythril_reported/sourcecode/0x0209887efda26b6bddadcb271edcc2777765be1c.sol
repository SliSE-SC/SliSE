...
contract CoinmitExToken is StandardToken, Pausable, Claimable {

  string public constant name = "CoinmitEx Token";
  ...
  constructor() public {
    ...
    totalSupply_ = 2100000000 ether; // 10 billion, 18 decimals (ether = 10^18)
