...
contract SecureOpenNets {
    ...
    function SON() public {
        ...
        name = 'SecureOpenNets';                        // Set the name for display purposes
        symbol = 'SON';                                   // Set the symbol for display purposes
        emit Transfer(0x0, msg.sender, 1000);
