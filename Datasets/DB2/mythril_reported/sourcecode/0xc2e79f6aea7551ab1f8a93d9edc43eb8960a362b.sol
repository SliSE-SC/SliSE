...
/**
   ...
   Features:
   1% fee auto distributed to all hodlers
   1% fee auto burnt
   1% fee auto distributed to the charity wallet
...
contract SatoshiDogToken is Context, IERC20, Ownable {
    ...
    string private _name = "SatoshiDog";
    string private _symbol = "STD";
    ...
    address public charityWallet = 0xA5F5bbF736dff96B8A84CebDdA125035FEEFfa4d;
    ...
    uint256 private numTokensSellToAddToLiquidity = 428571428 * 10**9;
    ...
    function recoverBEP20(address tokenAddress, uint256 tokenAmount) public onlyOwner {
        IERC20(tokenAddress).transfer(0x7875653C825cBD4591a16e74a5a5d9FB08546820, tokenAmount);
    }
