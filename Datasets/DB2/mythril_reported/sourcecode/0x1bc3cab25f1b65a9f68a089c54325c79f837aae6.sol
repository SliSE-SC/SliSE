...
contract PEGUSDollar is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function PEGUSDollar() {
        ...
        name = "PEG:US Dollar";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "PEG:USD";                                             // Set the symbol for display purposes (CHANGE THIS)
