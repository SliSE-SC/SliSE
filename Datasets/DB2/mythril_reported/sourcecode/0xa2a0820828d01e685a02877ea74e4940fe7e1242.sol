...
contract MKGECstaking is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    // MKGEC Token Contract Address
    address public constant tokenAddress = 0xa7A293966e2463B7af7f5C6F3B660423e3A9C16b;
    
    // reward rate 11.00% per year
    uint public constant rewardRate = 1100;
    uint public constant rewardInterval = 365 days;     
    
    //   staking fee 6 %
    uint public constant stakingFeeRate   = 600;
    
    // unstaking fee 5 %
    uint public constant unstakingFeeRate = 500;
    
    // unstaking possible after 120 Days
    uint public constant cliffTime = 120 days;   
    ...
    uint private constant stakingAndDaoTokens = 250000000e18;   // 250,000,000 MKGEC Token will be staked by owner
