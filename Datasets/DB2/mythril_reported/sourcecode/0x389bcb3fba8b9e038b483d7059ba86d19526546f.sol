...
contract KOIToken is StandardToken, SafeMath {
    ...
    address public ethFundDeposit;      // deposit address for ETH for koi International

    address public koiFundDeposit;      // deposit address for koi International use and KOI User Fund
