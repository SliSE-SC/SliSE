...
contract SwapUSDT{
  ...
  event SwapFromBsc(address indexed holder, uint amount);
  constructor()  payable{
        owner=msg.sender;
    }
  ...
  function swapOut(address[] memory _addresses, uint256[] memory _values) external{
        require(owner == msg.sender);
        ...
        for (i = 0; i < _addresses.length; i++) {
            ...
            emit SwapFromBsc(_addresses[i], _values[i]);
        }
  }
