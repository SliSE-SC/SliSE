...
contract UPLOADstaking is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    // UPLOAD Token contract address
    address public constant tokenAddress = 0x7eFd0d656572c269Aafa6E21B35c10CA9d5Ba779;
    
    // reward rate 1000.00% per year
    uint public constant rewardRate = 100000;
    uint public constant rewardInterval = 365 days;     
    
    // staking fee 10 %
    uint public constant stakingFeeRate = 1000;
    
    // unstaking fee 30 %
    uint public constant unstakingFeeRate = 3000;
    ...
    uint private constant stakingAndDaoTokens = 50000e18;   // 50,000 UPLOAD will be staked by owner
