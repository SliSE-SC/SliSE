...
// File: HeroesUpgrader.sol

contract HeroesUpgrader  is ERC1155Receiver, Ownable {
    ...
    function upgrade(uint256 oldHero, address modifierContract, uint256 modifierId) external {
