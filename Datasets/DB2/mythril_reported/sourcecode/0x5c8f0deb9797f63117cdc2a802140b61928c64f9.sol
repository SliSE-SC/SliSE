...
contract EtopayNetwork is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function EtopayNetwork() {
        ...
        name = "EtopayNetwork";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "EtoPay";                                             // Set the symbol for display purposes (CHANGE THIS)

        unitsOneEthCanBuy = 300000;                                      // Set the price of your token for the ICO (CHANGE THIS)
