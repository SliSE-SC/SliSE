 ...
 * This vesting smart contracts releases 50% of the tokens 6 months after the smart contract was initialized, and

 * 100% tokens become available for withdrawal after 1 year.
 ...
 * Once vesting period (1 year) ends and after all tokens are withdrawn, this smart contract self-destructs.
