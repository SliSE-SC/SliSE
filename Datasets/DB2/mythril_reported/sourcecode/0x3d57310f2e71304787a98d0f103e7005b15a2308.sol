...
contract lolcoin is StandardToken { // CHANGE THIS. Update the contract name.
   ...
   */
    ...
    function lolcoin() {
        ...
        totalSupply = 100000000000000000;                        // Update total supply (1000 for example) lolcoinlolcoin

        name = "lolcoin";                                   // Set the name for display purposes lolcoin

        decimals = 8;                                               // Amount of decimals for display purposes lolcoin lolcoin lolcoin lolcoin lolcoin

        symbol = "lol";                                             // Set the symbol for display purposes lolcoin

                                              // Set the price of your token for the ICO 

        fundsWallet = msg.sender;                                    // The owner of the contract gets ETH lolcoin
