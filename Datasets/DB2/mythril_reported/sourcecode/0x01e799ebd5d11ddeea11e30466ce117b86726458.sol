...
contract FTFExchangeToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function FTFExchangeToken() {
        ...
        balances[msg.sender] = 701000000000000000000000000000;               // Give the creator all initial tokens. This is set to 1000 for example. If you want your initial tokens to be X and your decimal is 5, set this value to X * 100000. (CHANGE THIS)
