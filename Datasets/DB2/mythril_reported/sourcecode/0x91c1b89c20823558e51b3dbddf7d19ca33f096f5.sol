...
contract SwapContractPDATAtoDateum {
  ...
  constructor (OpiriaToken _company_token) public {
    ...
    originalBalance = 5000000 * 10**18; // 5 000 000 PDATA

    currentBalance = originalBalance;

    alreadyTransfered = 0;

    startDateOfPayments = 1559347200; //From 01 Jun 2019, 00:00:00

    endDateOfPayments = 1575158400; //To 01 Dec 2019, 00:00:00
