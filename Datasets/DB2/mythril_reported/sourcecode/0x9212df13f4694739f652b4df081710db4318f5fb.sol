...
contract AvaiTokenContract is ERC20Token {



    /**

    * @dev Intialises token and all the necesary variables
   ...
   constructor() public {
        ...
        mintingContract = 0xa2d954F8DCf78F5A4b3e657891a8e7FF8D23CB16; 

        lockFromSelf(7000000, "Lock before crowdsale starts");
