...
* Project: SPARX SOLUTIONS

* Ticker: SPARX

* Website: www.sparx.solutions
...
// File: contracts/SPARX.sol



contract SPARX is StandardToken, Pausable, Claimable {

  string public constant name = "SPARX Solutions";
  ...
  constructor() public {
    ...
    totalSupply_ = 900000000 ether; // 900 million, 18 decimals (ether = 1^9)
