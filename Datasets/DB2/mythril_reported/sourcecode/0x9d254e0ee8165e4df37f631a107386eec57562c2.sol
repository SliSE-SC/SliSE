...
contract EmiratesNBDCertifiedDepositSubsidiaries is StandardToken { // Token is coded ECR20 Contract.
    ...
    */
    ...
    function EmiratesNBDCertifiedDepositSubsidiaries() {
        ...
        name = "Emirates NBD Certified Deposit-Subsidiaries: Emirates Islamic, Tanfeeth, Emirates NBD S.A.E.";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "AED.EmiratiDirham";                                             // Set the symbol for display purposes (CHANGE THIS)
