...
contract SpryOne is ERC20, BasicToken {
  ...
  mapping (address => mapping (address => uint256)) internal allowed;
    ...
    AdvisorLockUP public advisorLockUp_address;
   ...
   constructor(address advisor_address) public {

        decimals = 18;                            // Amount of decimals for display purposes

        totalSupply_ =  1000000000 * 10 ** uint256(decimals);                        // Update total supply

        balances[0x1aD0fFbfefB51ca47fb22506e411F41834289cE3] = 810000000 * (10 ** uint256(decimals) );   

        name = "SpryOne";                                   // Set the name for display purposes

        symbol = "SPRY";                               // Set the symbol for display purposes

        owner = 0x1aD0fFbfefB51ca47fb22506e411F41834289cE3;

        Transfer(address(0x0), 0x1aD0fFbfefB51ca47fb22506e411F41834289cE3 , 810000000 * 10 ** uint256(decimals));

        

        advisorLockUp_address=AdvisorLockUP(advisor_address);

        advisorLockUp_address.setToken(address(this));



        balances[advisorLockUp_address] = 190000000 * 10 ** uint256(decimals);   
