...
//make sure this function name matches the contract name above. So if you're token is called TutorialToken, make sure the //contract name above is also TutorialToken instead of ERC20Token
    ...
    function LUVTOKEN(
        ...
        totalSupply = 100000000000 * (10 ** uint256(decimals));                        // Update total supply (100000 for example)
...
contract LUV_Crowdsale is Ownable {
  ...
  uint256 public startTime = 1545710400;

  uint256 public endTime = 1579046400;
  ...
  // how many token units a buyer gets. 1 ETH = 300 LUV

  uint256 public phase_1_rate = 3000;
