...
contract WATERRESOURCESCOIN is StandardToken { // CHANGE THIS. Update the contract name.
   ...
   */
    ...
    function WATERRESOURCESCOIN () {
        ...
        name = "WATERRESOURCESCOIN";                                   // Set the name for display purposes (WATER RESOURCES COIN)
        decimals = 8;                                               // Amount of decimals for display purposes (WATER RESOURCES COIN)
        symbol = "WRC";                                             // Set the symbol for display purposes (WATER RESOURCES COIN)
