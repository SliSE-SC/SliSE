...
// FansCoin contract based on the full ERC20 Token Standard
// https://github.com/ethereum/EIPs/issues/20
// Smartcontract for FansCoin(FANS), for more information visit https://fanscoins.io and https://fanstars.me
// Verified Status: ERC20 Verified Token
// FansCoin Symbol: FANS


contract FansCoinToken { 
...
/**
 * FansCoin Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract FANSStandardToken is FansCoinToken, Ownable {
    
    using FANSMaths for uint256;
...
contract FansCoin is FANSStandardToken {
    ...
    */
    ...
    uint256 public totalSupply = 10000000000000000 ; // 100 million tokens, 8 decimal places
    string constant public name = "FansCoin";
    string constant public symbol = "FANS";
