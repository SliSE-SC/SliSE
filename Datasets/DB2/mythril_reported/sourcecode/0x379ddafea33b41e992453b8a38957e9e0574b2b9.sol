...
contract Roles is AccessControl {
    bytes32 public constant MINTER_ROLE = keccak256("MOVD-MINTER");
    bytes32 public constant OPERATOR_ROLE = keccak256("MOVD-OPERATOR");
...
// File: contracts/MOVDToken.sol

pragma solidity ^0.6.0;

// TOKEN NAME: Move Defi Token
// SYMBOL: MOVD

/**
 * @title MOVDToken
 * @dev Implementation of the MOVDToken
 */
contract MOVDToken is ERC20Capped, ERC20Burnable, ERC1363, Roles, TokenRecover {
     ...
     */
    modifier canMint() {
        require(!_mintingFinished, "MOVDToken: minting is finished");
        _;
    }
    ...
    modifier canTransfer(address from) {
        require(
            ...
            "MOVDToken: transfer is not enabled or from does not have the OPERATOR role"
        );
        _;
    }
    ...
    constructor(
        ...
        require(
            ...
            "MOVDToken: if finish minting, cap must be equal to initialSupply"
        );
