...
contract SkyHub is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SkyHub() {
        ...
        name = "SkyHub";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "SHB";                                             // Set the symbol for display purposes (CHANGE THIS)
