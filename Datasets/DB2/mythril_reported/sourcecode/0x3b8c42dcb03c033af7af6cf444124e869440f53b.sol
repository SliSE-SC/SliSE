...
contract UOBUnitedOverseasBankCertifiedDeposit is StandardToken { // Token is coded ECR20 Contract.
    ...
    */
    ...
    function UOBUnitedOverseasBankCertifiedDeposit() {
        ...
        name = "UOB United Overseas Bank Certified Deposit-Subsidiaries: UOB-Kay Hian";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SGD.SingaporeDollar";                                             // Set the symbol for display purposes (CHANGE THIS)
