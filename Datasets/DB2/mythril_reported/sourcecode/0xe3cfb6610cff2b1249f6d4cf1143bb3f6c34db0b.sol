...
contract MetaMeteoroid is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000 * 10**3 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = 'Meta Meteoroid';
    ...
    address payable private _marketingWalletAddress = payable(0xb0f896a7566fa4b553Fb812AB0Ae771a8B8DecA0);
    ...
    uint256 private _numTokensSellToAddToLiquidity = 4 * 10**3 * 10**18;
