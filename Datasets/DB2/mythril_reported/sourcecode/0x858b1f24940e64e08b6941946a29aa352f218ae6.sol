...
contract HungaryGold is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function HungaryGold() {
        ...
        name = "HungaryGold";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 2;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "HUG";                                             // Set the symbol for display purposes (CHANGE THIS)
