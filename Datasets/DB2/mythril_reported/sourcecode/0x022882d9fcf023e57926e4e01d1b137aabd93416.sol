...
contract Arkadiah is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Arkadiah() {
        ...
        name = "Arkadiah";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ARKA";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 20;                                      // Set the price of your token for the ICO (CHANGE THIS)
