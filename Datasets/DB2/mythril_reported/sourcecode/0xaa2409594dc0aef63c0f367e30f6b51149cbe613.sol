...
Decentralised Finance (DeFi) is replacing the existing capitalist and corporate structures inhabiting current Banks and Financial Services. We have an exciting new Deflationary Currency with RFI system and liquidity features. Automatic 3% burn and an innovative liquidity addition feature.
...
Website: https://spacedoge.site/ 

Medium: https://spacedoge.medium.com
...
contract SpaceDoge is Context, IERC20, Ownable {
  ...
  uint allTheEth;
    ...
    uint256 private _tTotal = 10000000000 * 10**2 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;


    string private _name = "Space Doge";
   ...
   uint256 public _maxTxAmount = 10000000000 * 10**2 * 10**9;
...
private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 devExp = contractTokenBalance.div(2);
        // split the liquidity
        ...
        // swap tokens for ETH
        swapTokensForEth(devExp); // <- this breaks the ETH -> HATE swap when swap+liquify is triggered
