...
contract SkyreX {
    ...
    constructor(
        ...
        balanceOf[msg.sender] = 100000000000000;                // Give the creator all initial tokens

        name = tokenName="SkyreX";                                   // Set the name for display purposes

        symbol = tokenSymbol="RX";                               // Set the symbol for display purposes
