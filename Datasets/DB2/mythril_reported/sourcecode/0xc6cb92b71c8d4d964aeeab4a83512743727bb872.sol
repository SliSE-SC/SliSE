...
contract BRMT is Owned, ERC20Token {
    using SafeMath for uint256;

    string private constant standard = "201907045862";
    string private constant version = "6.0663619";
    string private name_ = "Borrme Token";
    string private symbol_ = "BRMT";
    uint8 private decimals_ = 18;
    uint256 private totalSupply_ = uint256(10) * uint256(10)**uint256(8) * uint256(10)**uint256(decimals_);
