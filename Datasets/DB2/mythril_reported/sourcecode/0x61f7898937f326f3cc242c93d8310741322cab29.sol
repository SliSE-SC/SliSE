...
contract MBCHToken is ERC20Interface, Owned, SafeMath {

    string public symbol = "mbch";

    string public TokenOwner = "MBCH";

    string public  name = "MBCHToken";
	...
	address public ceo = 0x5A86f0cafD4ef3ba4f0344C138afcC84bd1ED222;
