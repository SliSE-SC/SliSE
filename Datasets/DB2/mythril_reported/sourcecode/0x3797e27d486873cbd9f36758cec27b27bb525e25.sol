...
// File: contracts/crowdsale/DripCrowdsale.sol
...
contract DripCrowdsale is ReentrancyGuard, TokenRecover {
    using SafeMath for uint256;
    ...
    constructor (uint256 rate, address payable wallet, IERC20Burnable token) {
