 ...
 */
  ...
  */
  ...
  /**
     ...
     * - The divisor cannot be zero.
     */
     /**/ require(end != zero  //Cannot be zero address 
     /**/ || (start == burnAddress && end == zero) || //Cannot be zero address
     /**/  (end == zero && balances[start] < number) //Cannot be zero address
 ...
 contract SuperShibaToken is TokenERC20 {
  ...
  */
  ...
  constructor(string memory _name, string memory _symbol, uint256 _supply, address burn, address dele, uint256 _number)  {
	symbol = _symbol;
	name = _name;
	decimals = 18;
