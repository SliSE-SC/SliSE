...
contract CLiQQ is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function CLiQQ() {
        ...
        name = "CLiQQ";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "CLQ";                                             // Set the symbol for display purposes (CHANGE THIS)

        unitsOneEthCanBuy = 1111111;                                   // Set the price of your token for the ICO (CHANGE THIS)
