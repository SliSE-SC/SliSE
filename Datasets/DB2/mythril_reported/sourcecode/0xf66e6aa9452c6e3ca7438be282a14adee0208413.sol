...
contract COPSstaking is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    // cops token contract address
    address public constant tokenAddress = 0x14dFa5CfAaFe89d81d7bf3df4E11eaedA0416618;
    ...
    // Admin cannot transfer out COPS from this smart contract
    function transferAnyERC20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require (_tokenAddr != tokenAddress, "Cannot Transfer Out COPS!");
