...
contract StandardToken is Token {
 ...
 contract BitcoinCompact is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function BitcoinCompact() {
        ...
        name = "Bitcoin Compact";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 2;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "BTC";                                             // Set the symbol for display purposes (CHANGE THIS)
