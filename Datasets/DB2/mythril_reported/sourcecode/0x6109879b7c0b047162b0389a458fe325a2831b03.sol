...
contract OunceToken is StandardToken { // CHANGE THIS. Update the contract name.
...
function OunceToken () public {
    ...
    name = "Ounce";                                   // Set the name for display purposes (CHANGE THIS)

    decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

    symbol = "OUNCE";                                             // Set the symbol for display purposes (CHANGE THIS)
