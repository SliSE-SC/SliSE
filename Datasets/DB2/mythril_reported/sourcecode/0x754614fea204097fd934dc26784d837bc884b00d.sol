...
// by he.guanjun, email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="bed6db90da90da90cdd6dfd0fed6d1cad3dfd7d290ddd1d3">[email&#160;protected]</a>
// 2017-09-27
// TODO：
...
contract  Erc20TokenMarket is Base         //for exchange token
{
    ...
    function receiveApproval(address _from, uint256 _value, address _token, bytes _extraData) public {
        ...
        var st = userSellingTokenOf[_from][_token];                 //用户(卖家)���址， Token地址，
    ...
    function disToken(address _token) public {          //处理捡到的各种Token，也就是别人误操作，直接给 this 发送了 token 。由调用者和Owner平分。因为这种误操作���致的丢失过去一年的损失达到几十万美元。
