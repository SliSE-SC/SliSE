...
contract beesfinancestaking is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    // beesfinance token contract address
    address public constant tokenAddress = 0xC483ad6F9B80B38691E95b708DE1d46721366ce3;
