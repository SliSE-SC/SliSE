...
contract TestToken is Context, IBEP20, Ownable {
    ...
    uint256 private _totalSupply = 217000000000;
    uint256 public fee = 250;
    uint256 public dominator = 10000;

    address public feeAddress = 0x049a203AC85b2Bca08DfC12841162cc4BEeD42d9;

    string private _name = "Super Currency";
    string private _symbol = "SCUR";
    ...
    function setFee(uint256 _fee) public onlyOwner {
        require(fee < dominator , "Fee setting error!");
        fee = _fee;
    }
    ...
    function _transfer(
        ...
        {
            uint256 feeAmount = amount.mul(fee).div(dominator);
