...
This smart contract is intended for entertainment purposes only. Crypto currency gambling is illegal in many jurisdictions and users should consult legal counsel regarding the legal status of cryptocurrency gambling in their jurisdictions.
...
If you reside in a location where gambling or crypto currency transactions over the internet or otherwise is illegal, please do not use this smart contract. You must be 21 years of age to use this smart contract even if it is legal to do so in your location.

Users in the U.S. should be aware that the U.S. government has taken the position that it is illegal for online casinos and sportsbooks to accept wagers from persons in the U.S.

If you reside in the U.S. or intend to promote this smart contract to U.S. residents please do not interact with this smart contract in any way and leave this smart contract  immediately.
