...
contract EthereumPlus is Context, IERC20, Ownable {
    ...
    string private _name = 'Ethereum Plus';
    string private _symbol = 'ePlus';
    ...
    address payable private _marketingWalletAddress = payable(0x5fd176ec88795472B79B03EBa27E8dedaC11EfCf);
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xCD87C10A63f8c92302AcbF13bC682a12F19fDab7); // UniswapV2 for Ethereum network
        ...
        _isBlackListedBot[address(0x1f5beEF4C44DE8A4C95954C1bc95bC746A083289)] = true;
        _blackListedBots.push(address(0x1f5beEF4C44DE8A4C95954C1bc95bC746A083289));      
    ...
    function excludeFromReward(address account) external onlyOwner() {
        require(account != 0xCD87C10A63f8c92302AcbF13bC682a12F19fDab7, 'We can not exclude Uniswap router.');
    ...
    function addBotToBlackList(address account) external onlyOwner() {
        require(account != 0xCD87C10A63f8c92302AcbF13bC682a12F19fDab7, 'We can not blacklist Uniswap router.');
