...
interface IFeeApprover {
    ...
    function setXCORETokenAddress(address _XCORETokenAddress) external;
...
contract NBUNIERC20 is Context, INBUNIERC20, Ownable {
    ...
    string public liquidityGenerationParticipationAgreement = "I agree that the developers and affiliated parties of the XCORE team are not responsible for your funds";
    ...
    function addLiquidityToUniswapXCORExWETHPair() public {
    ...
    function _transfer(
        ...
        if(transferToFeeDistributorAmount > 0 && feeDistributor != address(0)){
            ...
            if(feeDistributor != address(0)){
                IXCOREVault(feeDistributor).addPendingRewards(transferToFeeDistributorAmount);
            }
        }
    }
...
// XCOREToken with Governance.
contract XCORE is NBUNIERC20 {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "XCORE::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "XCORE::delegateBySig: invalid nonce");
        require(now <= expiry, "XCORE::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "XCORE::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying XCORE tokens (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "XCORE::_writeCheckpoint: block number exceeds 32 bits");
