...
contract Planetarium is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Planetarium() {
        ...
        name = "Planetarium";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "PLNT";                                             // Set the symbol for display purposes (CHANGE THIS)
