...
contract EthS is Context, IERC20, Ownable {
    ...
    string private _name = 'Eth S';
    string private _symbol = 'ES';
    uint8 private _decimals = 9;

    uint256 private _taxFee = 2; // 4% reflection fee for every holder
    uint256 private _marketingFee = 1; // 2% marketing
    uint256 private _liquidityFee = 3; // 2% into liquidity

    uint256 private _previousTaxFee = _taxFee;
    uint256 private _previousMarketingFee = _marketingFee;
    uint256 private _previousLiquidityFee = _liquidityFee;

    address payable private _marketingWalletAddress = payable(0x56DE22417186F3363Db61Ce17f2b7F9914Db1C47);
