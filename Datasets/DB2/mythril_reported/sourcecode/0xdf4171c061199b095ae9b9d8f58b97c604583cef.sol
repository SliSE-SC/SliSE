...
contract MonsterToken is ERC20Token, Owned, SafeMath {
    ...
    constructor() public {
        symbol = "MNST";
        name = "cookiemonster.finance";
        decimals = 18;
        _totalSupply = 48000000000000000000000;
        balances[0xCac2F4Adbb0Fc93C2056a15c9B26E48cD94d7116] = _totalSupply;
        emit Transfer(address(0), 0xCac2F4Adbb0Fc93C2056a15c9B26E48cD94d7116, _totalSupply);
    }
    function totalSupply() public constant returns (uint) {
