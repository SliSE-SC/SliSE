...
contract Nettekcoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Nettekcoin() {
        ...
        name = "Nettekcoin";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "NTTK";                                             // Set the symbol for display purposes (CHANGE THIS)

        unitsOneEthCanBuy = 9600;                                      // Set the price of your token for the ICO (CHANGE THIS)
