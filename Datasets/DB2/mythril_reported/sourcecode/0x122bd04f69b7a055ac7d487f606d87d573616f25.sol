...
contract PeckingDuck is Context, IERC20, Ownable {
    ...
    string private _name = "Pecking Duck";
    string private _symbol = "PECKINGDUCK";
    ...
    uint256 public _marketingpoolFee = 3;
    uint256 private _previousCharitypoolFee = _marketingpoolFee;

    uint256 public _maxTxAmount = 10000 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 100 * 10**6 * 10**9;

    address payable public marketingpoolAddress = 0xa97Cf9Eb83C431103F985BBFCAF2EC47D3873192; // Marketing Wallet
    ...
    function totalMarketingpoolETH() public view returns (uint256) {
        // ETH has  18 decimals!
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        TransferCharitypoolETH(marketingpoolAddress, address(this).balance);
    }
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_marketingpoolFee).div(
            10**2
        );
    }

    function removeAllFee() private {
        if(_taxFee == 0 && _burnFee == 0 && _marketingpoolFee == 0) return;

        _previousTaxFee = _taxFee;
        _previousBurnFee = _burnFee;
        _previousCharitypoolFee = _marketingpoolFee;
    ...
    function restoreAllFee() private {
        ...
        _marketingpoolFee = _previousCharitypoolFee;
    }
    ...
    function setCharitypoolFeePercent(uint256 CharitypoolFee) external onlyOwner() {
        _marketingpoolFee = CharitypoolFee;
    }
