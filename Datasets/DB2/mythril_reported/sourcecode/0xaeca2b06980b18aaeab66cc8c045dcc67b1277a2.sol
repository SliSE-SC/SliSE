...
contract ERC20Token is StandardToken {
    ...
    */
    string public name = "TESTTHONK";                   //fancy name: eg Simon Bucks
    ...
    string public symbol = "THK";                 //An identifier: eg SBX
...
//make sure this function name matches the contract name above. So if you're token is called TutorialToken, make sure the //contract name above is also TutorialToken instead of ERC20Token
    ...
    function ERC20Token(
        ...
        totalSupply = 32863359;                        // Update total supply (100000 for example)
        name = "Thonk";                                   // Set the name for display purposes
        decimals = 8;                            // Amount of decimals for display purposes
        symbol = "THK";                               // Set the symbol for display purposes
    }
