...
contract NcovDeadPool  {
    ...
    function claim() public {
        ...
        if (diffinf <= 5000*10**18) {
            reward(myamount*3*dayQ);
        } else if (diffinf <= 10000*10**18) {
            reward(myamount*2*dayQ);
        } else if (diffinf <= 20000*10**18) {
            reward(myamount*3/2*dayQ);
        } else if (diffinf <= 25000*10**18) {
            reward(myamount*13/10*dayQ);
        } else if (diffinf <= 30000*10**18) {
            reward(myamount*6/5*dayQ);
        } else if (diffinf <= 50000*10**18) {
