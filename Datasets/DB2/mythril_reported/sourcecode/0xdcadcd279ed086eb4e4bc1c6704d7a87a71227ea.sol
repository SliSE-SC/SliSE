...
contract PBSU is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function PBSU() {
        ...
        name = "Prabowo & Sandiaga";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "PBSU";                                             // Set the symbol for display purposes (CHANGE THIS)
