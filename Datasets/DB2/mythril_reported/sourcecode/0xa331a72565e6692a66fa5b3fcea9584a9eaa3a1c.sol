...
// Deodex Token contract based on the full ERC 20 Token standard

// https://github.com/ethereum/EIPs/issues/20

// Smartcontract for Deodex, for more information visit https://Deodex.co
 ...
 * Deodex Math operations with safety checks to avoid unnecessary conflicts
...
contract StandardToken is Deodex, Ownable {

    

    using DDEXMaths for uint256;
...
contract DDEX is StandardToken {
    ...
    */
    ...
    string constant public name = "Deodex"; //fancy name: eg Deodex

    string constant public symbol = "DDEX"; //An identifier: eg DDEX
