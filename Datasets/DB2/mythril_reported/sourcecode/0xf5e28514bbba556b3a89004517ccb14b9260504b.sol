...
contract GaugeD2_USDC is IERC20, ReentrancyGuard {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;

    address payable public governance = 0xdD7A75CC6c04031629f13848Bc0D07e89C3961Be; // STACK DAO Council Multisig
    address public constant acceptToken = 0x067b9FE006E16f52BBf647aB6799f87566480D2c; // stackToken USDC rebase token
