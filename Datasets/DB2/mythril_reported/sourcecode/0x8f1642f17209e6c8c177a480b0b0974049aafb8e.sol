...
/**
 * @title aeos Main Contract
 */
contract aeos is Ownable, Pausable, IERC20 {
    using SafeMath for uint256;

    string private _name = "aeos";
    string private _symbol = "aeos";
    uint256 private _decimals = 18;                // 18 decimals
    uint256 private _cap = 20000000000 * 10 **_decimals;   
