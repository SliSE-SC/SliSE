...
contract RockeTraffiCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function RockeTraffiCoin() {
        ...
        name = "RockeTraffiCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 7;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "RTC";                                             // Set the symbol for display purposes (CHANGE THIS)
