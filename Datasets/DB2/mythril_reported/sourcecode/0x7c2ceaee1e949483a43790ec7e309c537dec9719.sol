...
//                                      &&&&@@@@@@@@@@&&&&##%&@@@@@@@@@&%&@.                                             
//
//    SUPRA INU --- NEXT GEN DOG COIN --- 10x 100x 1000x --- WHERE WILL YOU STOP???
//
//    ==================================== IN DOG WE TRUST ===========================
//
//    SUPRA.INU --- SUPRA.INU --- SUPRA.INU --- SUPRA.INU --- SUPRA.INU --- SUPRA.INU
...
contract SUPRA is IERC20 {
    ...
    string private _name = "SUPRA INU";
    
    string private _symbol = "SUPRA";
    ...
    constructor () {
        ...
        _transfer(address(this), vitalik, _initialSupply*40/100);
