...
contract PatlicanCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function HashnodeTestCoin() {
        ...
        name = "PatlicanCoin";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 2;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "PTL";                                             // Set the symbol for display purposes (CHANGE THIS)
