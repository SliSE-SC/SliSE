...
contract GlobalNetworkChain is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function GlobalNetworkChain() {
        ...
        name = "GlobalNetworkChain";                                   // Set the name for display purposes ()

        decimals = 18;                                               // Amount of decimals for display purposes (18)

        symbol = "GNC";                                             // Set the symbol for display purposes ()
