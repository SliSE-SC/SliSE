...
contract StandardToken is Token {
 ...
 contract EthBlockExplorer is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function EthBlockExplorer() {
        ...
        name = "Ethereum Block Explorer";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 5;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "ETS";                                             // Set the symbol for display purposes (CHANGE THIS)
