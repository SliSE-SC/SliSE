...
contract TitanTestToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TitanTestToken() {
        ...
        name = "TitanTestToken";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "TTT";                                             // Set the symbol for display purposes (CHANGE THIS)
