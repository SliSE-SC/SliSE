...
contract SPACETokenSafe is TokenSafe {
...

  {
    ...
    init(
      ...
      1547510400 // Release date = 2019-01-15 00:00 UTC
    ...
    add(
      ...
      0x80C82349860c720e1A2197bA603FF69E396021fc,  // Token Safe Entry Address

      315000000000000000000000  // Allocated tokens
...
contract SPACETokenFundraiser is MintableTokenFundraiser, PresaleFundraiser, IndividualCapsFundraiser, ForwardFundsFundraiser, TieredFundraiser, GasPriceLimitFundraiser {
...

    {
        ...
        initializeBasicFundraiser(
            ...
            1546300800, // Start date = 2019-01-01 00:00 UTC

            1567295940,  // End date = 2019-08-31 23:59 UTC

            1, // Conversion rate = 1 SP per 1 ether

            0x413C7299268466e2E68A179750EBB7aC2d1D9160     // Beneficiary
        ...
        initializeGasPriceLimitFundraiser(
            ...
            200000000000000 // Gas price limit in wei
        ...
        initializePresaleFundraiser(
            ...
            1542412800, // Start = 2018-11-17 00:00 UTC

            1546300740,   // End = 2018-12-31 23:59 UTC
