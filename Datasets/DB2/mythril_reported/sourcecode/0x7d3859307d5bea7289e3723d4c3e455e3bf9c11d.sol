...
// WallStreetFinance Staking - Innovative Defi Project, by the people for the people
...
contract WSFstaking is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    // WSF token contract address
    address public constant tokenAddress = 0x4819a96eB4b22454d628Cd683aE052C2c9076808;
    
    // reward rate 100.00% per year
    uint public constant rewardRate = 10000;
    uint public constant rewardInterval = 365 days;
    
    // staking fee 2.50 percent
    uint public constant stakingFeeRate = 250;
    ...
    uint private constant stakingAndDaoTokens = 3000e18;
    ...
    // Admin cannot transfer out WSF from this smart contract
    function transferAnyERC20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require (_tokenAddr != tokenAddress, "Cannot Transfer Out WSF!");
