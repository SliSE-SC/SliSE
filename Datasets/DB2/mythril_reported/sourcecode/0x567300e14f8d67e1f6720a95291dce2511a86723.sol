...
contract HelperSearchToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function HelperSearchToken() {
        ...
        name = "Helper Search Token";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "HSN";                                             // Set the symbol for display purposes (CHANGE THIS)
