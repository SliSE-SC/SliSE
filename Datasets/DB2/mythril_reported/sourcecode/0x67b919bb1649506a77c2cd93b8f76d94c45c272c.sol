...
/* --------------코인명 CHELCOIN  심볼 CCC로 -------------------

createdate : 2018.11.08  2rd and last Token.
...
This is coinchel.com CCC TOKEN 
...
contract CHELCOIN  is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function CHELCOIN() {
        ...
        name = "CHELCOIN";                                         // Set the name for display purposes ( coinchel  )

        decimals = 6;                                               // Amount of decimals for display purposes ( coinchel )

        symbol = "CCC";                                             // Set the symbol for display purposes (coinchel )
