    ...
    Ownable
{
    ...
    string _name = "NYC Streetz";
    string _symbol = "NYCS";

    constructor(
    ) ERC721(_name, _symbol) {
        baseTokenURI = "https://streetz.nyc/api/streets/";
    ...
    function setMaxSupply(uint256 newMaxSupply) external onlyOwner {
        require(newMaxSupply > _currentTokenId, "New Max Supply must be greater than current mint");
    ...
    function _incrementTokenId() private {
        require(_currentTokenId < maxSupply);

        _currentTokenId++;
    }

    /**
     * @dev change the baseURI if there are future problems with the API service
     */
