...
contract CoinTrim is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function CoinTrim() {
        ...
        name = "CoinTrim";                                           // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "CTNN";                                             // Set the symbol for display purposes (CHANGE THIS)
