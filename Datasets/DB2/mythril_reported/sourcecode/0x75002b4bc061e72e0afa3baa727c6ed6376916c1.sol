...
contract AgaCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function AgaCoin() {
        ...
        name = "AgaCoin";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "AGA";                                             // Set the symbol for display purposes (CHANGE THIS)

        unitsOneEthCanBuy = 913;                                      // Set the price of your token for the ICO (CHANGE THIS)
