...
// -----------------------------------------------------------------------
// GRV Token by Gravity Network Foundation.
// An ERC20 standard
contract ERC20 {
...
contract GRVTokenBase is ERC20 {
     ...
     */
    function GRVTokenBase(uint256 _initialSupply, string _tokenName, string _tokenSymbol, uint8 _decimals) public {
...
contract GRVToken is GRVTokenBase {

    function GRVToken() GRVTokenBase(10000000000, "GRV Token", "GRV", 18) public {
