...
contract Bitsdaq is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Bitsdaq() {
        ...
        name = "Bitsdaq";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "BQQQ";                                             // Set the symbol for display purposes (CHANGE THIS)
