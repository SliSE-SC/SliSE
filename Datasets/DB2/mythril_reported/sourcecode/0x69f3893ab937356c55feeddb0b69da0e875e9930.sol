...
contract OneInchTrade is IOneInchTrade {
    ...
    function() external payable {
        ...
        if (kyberTradingAmount > bancorTradingAmount) {
            ...
            emit Trade("buy", bancorTradingAmount, "bancor");

            emit Trade("sell", kyberTradingAmount, "kyber");
            ...
            emit Trade("buy", kyberTradingAmount, "kyber");

            emit Trade("sell", bancorTradingAmount, "bancor");
