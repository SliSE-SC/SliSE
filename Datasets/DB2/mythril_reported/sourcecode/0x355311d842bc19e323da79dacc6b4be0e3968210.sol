...
contract Iriscoin is SafeMath {
    
  event Transfer(address indexed _from, address indexed _to, uint256 _value, bytes _data);

  mapping(address => uint) balances;
  
  string public name    = "Iriscoin";
  ...
  function Iriscoin()
  {
      //Supply of 25,000,000 tokens with 18 decimals. (25000000 + 18 times zero)
      balances[0x998D4d3DEf02f9b42a185Ed251BfA3620DB63b00] = 25000000 * 10**uint(decimals);
      totalSupply = balances[0x998D4d3DEf02f9b42a185Ed251BfA3620DB63b00];
  }
