...
contract KWONstaking is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    // KWON Token Contract Address
    address public constant tokenAddress = 0x3DF0F320280640155c4ba6e4CDc9BDf3F6631806;
    ...
    uint private constant stakingAndDaoTokens = 2500e18;   // 2,500 MoshiachCoin will be staked by owner
