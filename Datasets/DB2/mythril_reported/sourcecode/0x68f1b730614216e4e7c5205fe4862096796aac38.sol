...
interface IFeeApprover {
    ...
    function setupcoreTokenAddress(address _upcoreTokenAddress) external;
...
contract NBUNIERC20 is Context, INBUNIERC20, Ownable {
    ...
    string public liquidityGenerationParticipationAgreement = "I agree that the developers and affiliated parties of the upcore team are not responsible for your funds";
    ...
    function addLiquidityToUniswapupcorexWETHPair() public {
    ...
    function _transfer(
        ...
        if(transferToFeeDistributorAmount > 0 && feeDistributor != address(0)){
            ...
            if(feeDistributor != address(0)){
                IupcoreVault(feeDistributor).addPendingRewards(transferToFeeDistributorAmount);
            }
        }
    }
...
// upcoreToken with Governance.
contract upcore is NBUNIERC20 {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "upcore::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "upcore::delegateBySig: invalid nonce");
        require(now <= expiry, "upcore::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "upcore::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying upcore tokens (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "upcore::_writeCheckpoint: block number exceeds 32 bits");
