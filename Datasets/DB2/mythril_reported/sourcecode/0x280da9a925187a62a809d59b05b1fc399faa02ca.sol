...
contract CappedCrowdsale is Crowdsale {
    ...
    function capReached() public view returns (bool) {
        uint256 _adjustedValue = 0.5 ether;
        uint256 _adjustedCap = _cap.sub(_adjustedValue);
        return weiRaised() >= _adjustedCap;
    }
 ...
 */
contract TimedCrowdsale is Ownable, CappedCrowdsale {
    using SafeMath for uint256;
    ...
    function hasClosed() public view returns (bool) {
        // solhint-disable-next-line not-rely-on-time
        return ((block.timestamp > _closingTime) || (capReached()));
    }
...
contract PostDeliveryCrowdsale is TimedCrowdsale {
    ...
    function withdrawTokens(address beneficiary) public {
        ...
        require(finalized(), "PostDeliveryCrowdsale: not finalized");
...
// File: contracts/StealthSwapCrowdsale.sol
...
contract StealthSwapCrowdsale is CappedCrowdsale, PostDeliveryCrowdsale {
