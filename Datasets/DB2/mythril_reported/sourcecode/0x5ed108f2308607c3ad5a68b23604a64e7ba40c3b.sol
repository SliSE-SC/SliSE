...
contract Loom is owned, token {
    ...
    string public tokenName = "Loom";

    string public tokenSymbol = "LOOM";

    function Loom() token (initialSupply, tokenName, decimalUnits, tokenSymbol) {}
