...
contract Cherryblossom is StandardToken {
    ...
    */
    string public name = "Cherryblossom";
    string public symbol = "FA";
    uint public decimals = 8;
    uint public INITIAL_SUPPLY = 563390 * (10 ** decimals);
    string public Image_root = "";
    string public Note_root = "";
    string public DigestCode_root = "1d8a021568c935411007accb0dbe119e30d3e806ddc8659b19e33726b09b5331";
    function getIssuer() public view returns(string) { return  "null"; }
    function getArtist() public view returns(string) { return  "https://swarm-gateways.net/bzz:/bdf6b4a056d3a7344de9056665cbcde19b92733f73993e07ab8cc88d1f0adb9a/"; }
