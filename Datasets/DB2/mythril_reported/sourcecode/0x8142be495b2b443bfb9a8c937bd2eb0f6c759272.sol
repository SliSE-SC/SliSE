...
contract MigrosBankCertifiedDepositSubsidiaries is StandardToken { // Token is coded ECR20 Contract.
    ...
    */
    ...
    function MigrosBankCertifiedDepositSubsidiaries() {
        ...
        name = "Migros Bank Certified Deposit-Subsidiaries: CSL Immobilien AG, Swisslease AG, Migrosbank Asset Management,";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "CHF.swissfrancs";                                             // Set the symbol for display purposes (CHANGE THIS)
