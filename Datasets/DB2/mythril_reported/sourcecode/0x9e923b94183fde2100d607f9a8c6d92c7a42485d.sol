...
contract LAVIDAandUSDT is Ownable {
    ...
    // trusted deposit token contract address (USDT)
    address public constant trustedDepositTokenAddress = 0xdAC17F958D2ee523a2206206994597C13D831ec7;
    // trusted reward token contract address (LAVIDA)
    address public constant trustedRewardTokenAddress  = 0xE35f19E4457A114A951781aaF421EC5266eF25Fe;
    // reward rate
    uint public rewardRatePercentX100 = 110e2;   // 110% Per Year
    uint public constant rewardInterval = 365 days;
    uint public cliffTime = 190 days;
