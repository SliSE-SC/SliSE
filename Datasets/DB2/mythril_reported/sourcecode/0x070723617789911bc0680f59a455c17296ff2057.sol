...
contract SmartToken is ISmartToken, Owned, ERC20Token, TokenHolder {
    ...
    uint256 public constant MAX_SUPPLY = 1600000000000000000000000000; // 1.6 billion
    ...
    event Recycling(uint256 _amount);

    // triggered when the destroy token
    ...
    */
    ...
    modifier notFrozen(address _address) {
        ...
        require(isFrozen[_address] == false);
    ...
    modifier notReachCap(uint256 _amount) {
        ...
        require(safeAdd(totalSupply, _amount) <= MAX_SUPPLY);
    ...
    */
...

    {
     ...
     /**
        ...
        @dev removes tokens from an account

        can be called any holder to destroy tokens from his/her own account

        @param _from    this is a trashy param

        @param _amount     amount to destroy by
    ...
    */
    ...
    /**
        ...
        @dev recycle tokens from an account and decreases the token supply

        can be called by  any holder to destroy his/her own account
    ...
    */
    ...
    function recycle(uint256 _amount) public {
