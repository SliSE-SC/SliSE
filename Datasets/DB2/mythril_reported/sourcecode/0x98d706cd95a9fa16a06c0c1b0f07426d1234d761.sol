...
/**
 * @title Crowdsale ALT0 presale token
 */

contract Crowdsale is Ownable {
  using SafeMath for uint256;

  uint256   public constant rate = 680;                   // How many token units a buyer gets per wei
  uint256   public constant cap = 5000000 ether / rate;   // Maximum amount of funds

  bool      public isFinalized = false;
  uint256   public endTime = 1517097600;                  // End timestamps where investments are allowed
                                                          // Sunday, 28 January 2018, 00:00:00 GMT

  ALT0Token public token;                                 // ALT0 token itself
