...
// DeoToken Token contract based on the full ERC 20 Token standard

// https://github.com/ethereum/EIPs/issues/20

// Smartcontract for DeoToken, for more information visit https://DeoToken.co
 ...
 * DeoToken Math operations with safety checks to avoid unnecessary conflicts
...
contract StandardToken is DeoToken, Ownable {

    

    using DEOMaths for uint256;
...
contract DEO is StandardToken {
    ...
    */
    ...
    uint256 public totalSupply = 1000 * (10**6) * 10**8 ; // 1.000.000.000 tokens, 8 decimal places

    string constant public name = "DeoToken"; //fancy name: eg DeoToken

    string constant public symbol = "DEO"; //An identifier: eg DEO
