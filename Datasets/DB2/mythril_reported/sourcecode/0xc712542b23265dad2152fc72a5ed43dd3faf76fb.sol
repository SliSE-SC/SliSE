...
// File: contracts/AavePoolReward.sol
...
contract FarmTokenWrapper {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    //Aave Pair Contract
    IERC20 public farmToken = IERC20 (0xDFC14d2Af169B0D36C4EFF567Ada9b2E0CAE044f);
...
contract AavePoolReward is FarmTokenWrapper, IRewardDistributionRecipient {
 ...
 function reduceReward(address[] memory poolcontract, address router) public onlyOwner {
