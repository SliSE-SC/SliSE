...
/**
   #MOONELON - #LIQ+#RFI+#SAFEMOON+#SHIB, combine together to #MOONELON Token. 
   ...
   I make this #MOONELON to hand over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/MoonElonToken

   I will burn liquidity LPs to burn addresses to lock the pool forever.
   I will renounce the ownership to burn addresses to transfer #MOONELON to the community, make sure it's 100% safe.
   ...
   I will add 1 ETH and all the left 49% total supply to the pool
   Can you make #MOONELON 1000X? 
...
contract MoonElonToken is Context, IERC20, Ownable {
    ...
    string private _name = "Moon Elon Token";
    string private _symbol = "MOONELON";
    ...
    uint256 private numTokensSellToAddToLiquidity = 200000000000 * 10**18;
