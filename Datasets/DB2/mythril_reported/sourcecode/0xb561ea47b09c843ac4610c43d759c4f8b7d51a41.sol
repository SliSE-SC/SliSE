...
contract DJToken is MinterRole, IERC20 {
    ...
    function withdraw() onlyOwner public { //owner can withdraw ether from contract
        ...
        function emergencyToken(address _tokenContract) onlyOwner public {
     ...
     function depositETH() public payable { //added deposit wan function
        require(msg.value > 0);
    }
    ...
    function emergency() onlyOwner public {
