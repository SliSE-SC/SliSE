...
contract EthereumPro is Context, IERC20, Ownable {
    ...
    string private _name = 'ETH Clone';
    string private _symbol = 'ECL';
    uint8 private _decimals = 9;

    uint256 private _taxFee = 1; // 4% reflection fee for every holder
    uint256 private _marketingFee = 5; // 2% marketing
    ...
    address payable private _marketingWalletAddress = payable(0x0fe60E55a8C0700b47d4a2663079c445Fc4A5893);
