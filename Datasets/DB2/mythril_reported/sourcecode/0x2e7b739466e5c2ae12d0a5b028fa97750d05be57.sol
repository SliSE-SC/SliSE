...
/**
ERC-20 interactive cookie-clicker type gamification with crypto prizes.
...
contract PIXELHOTEL is Context, IERC20, Ownable {
    ...
    string private _name = 'PixelHotel\xF0\x9F\x8F\xA8 | t.me/PIXELHOTEL';
    string private _symbol = 'HOTPIX';
    uint8 private _decimals = 9;

    uint256 private _taxFee = 4; // 2% to holder and 2% burn
    uint256 private _marketingFee = 0; // no marketing fee
    uint256 private _liquidityFee = 2; // 2% LP

    uint256 private _previousTaxFee = _taxFee;
    uint256 private _previousMarketingFee = _marketingFee;
    uint256 private _previousLiquidityFee = _liquidityFee;

    address payable private _marketingWalletAddress = payable(0x0F01088235809815e1Bf828fE7eD4BA1b5203EaF);
