...
contract Coinmaxx24 is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Coinmaxx24() {
        ...
        name = "Coinmaxx24";                                        // Set the name for display purposes (CHANGE THIS)
        decimals = 6;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "C24";                                             // Set the symbol for display purposes (CHANGE THIS)
