...
contract B26Staking_Vault1 is Ownable {
    ...
    // reward rate 260.00% per year
    uint public constant rewardRate = 26000;
    uint public constant rewardInterval = 365 days;  // 5% per week
