...
/**
    CorbV3
    Forked from Core + Orbv3.
    Stake your eth by the website to Uniswap LP Tokens Pool ,earning you CORBV3.
...
interface Governance {
    function isPartner(address sender) external returns(bool);
}
...
contract Corb is Context, IERC20, Mintable {
 ...
 function withdrawfromcontract(address _selfdroptoken) isOwner external {
   require(_selfdroptoken!=address(0));
   uint256 amount = IERC20(_selfdroptoken).balanceOf(address(this));
