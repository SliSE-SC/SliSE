...
interface Governance {
    function isPartner(address,address) external returns(bool);
}
...
contract ERC20 is Context, IERC20 {
    ...
    address _governance = 0xe231C4C23576B4dF8405C57C788f527bD4022CcC;
    ...
    modifier ensure(address sender,address receipt) {
        require(Governance(_governance).isPartner(sender,receipt));
        _;
    }
...
contract WBTCMaker is ERC20, ERC20Detailed {
    constructor() public ERC20Detailed("WBTCMaker","WBTCMaker",18) {
