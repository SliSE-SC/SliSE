...
contract ForceCryptoInvestmentCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function ForceCryptoInvestmentCoin() {
        ...
        name = "ForceCryptoInvestmentCoin";                                   // Set the name for display purposes (CHANGE THIS)

        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)

        symbol = "FCIC";                                             // Set the symbol for display purposes (CHANGE THIS)
