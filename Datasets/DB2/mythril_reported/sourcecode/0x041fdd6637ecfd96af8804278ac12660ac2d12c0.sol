...
function Token(
 ...
 balances[msg.sender] = 10000000000000000; // تمام توکنهای ساخته شده سازنده برسد -عددی وارد کنید مثلا 100000
 totalSupply = 10000000000000000; // تمام عرضه
 name = 'SwapDEX'; // نام توکن
 decimals = 7; // اعشار
 symbol = 'SDX'; // نماد توکن
 }
