...
contract SecvaultTokenSafe is TokenSafe {
...

  {
    ...
    init(
      ...
      1542261600 // Release date = 2018-11-15 06:00 UTC
    ...
    add(
      ...
      0xE95767DF573778366C3b8cE79DA89C692A384d63,  // Token Safe Entry Address

      42000000000000000000000000  // Allocated tokens
    ...
    init(
      ...
      1540141200 // Release date = 2018-10-21 17:00 UTC
    ...
    add(
      ...
      0x089B79da930C8210C825E2379518311ecD9d9f39,  // Token Safe Entry Address

      24500000000000000000000000  // Allocated tokens

    );

    

    // Group "Ecosystem & Partnership"
    ...
    add(
      ...
      0x82c7DEf4F7eEA9a8FF6aD7ca72025f3E20C151D4,  // Token Safe Entry Address
...
contract SecvaultTokenFundraiser is MintableTokenFundraiser, PresaleFundraiser, IndividualCapsFundraiser, CappedFundraiser, ForwardFundsFundraiser, GasPriceLimitFundraiser {
...

    {
        ...
        initializeBasicFundraiser(
            ...
            1547100000, // Start date = 2019-01-10 06:00 UTC

            1549821600,  // End date = 2019-02-10 18:00 UTC

            600, // Conversion rate = 600 BPI per 1 ether

            0xE95767DF573778366C3b8cE79DA89C692A384d63     // Beneficiary
        ...
        initializeIndividualCapsFundraiser(
            ...
            (0.5 ether), // Minimum contribution
        ...
        initializePresaleFundraiser(
            ...
            1540141200, // Start = 2018-10-21 17:00 UTC

            1543168800,   // End = 2018-11-25 18:00 UTC
