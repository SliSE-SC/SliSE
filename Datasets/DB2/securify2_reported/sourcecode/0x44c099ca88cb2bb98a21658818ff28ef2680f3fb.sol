...
My URL : https://ultraspace.network/
Hashtag: #ultraspace
*/
...
contract UltraSpace {
   ...
   uint pool9_price=32 ether;
   uint pool10_price=64 ether;
   uint pool11_price=128 ether;
   uint pool12_price=256 ether;
