...
contract privateSale1ETH is Context {
    ...
    uint256 public minimumBuyAmount = 1 ether; 	//min buy is 1 ETH
    uint256 public maximumBuyAmount = 4.99 ether;  //max buy is 4.99 ETH
    ...
    constructor () public {
        ...
        rate = uint256(3000);									                    //this rate means 1 ETH = 3000 Utrin Tokens
    ...
    function buy() public payable {
        ...
        require((weiValue >= minimumBuyAmount) &&(weiValue<= maximumBuyAmount), "Minimum amount is 1 eth and Maximum amount is 4.99 Eth");
