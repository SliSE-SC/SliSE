...
// SCAN-License-Identifier: UNLICENSED
// tokenscan.tools All Rights Reseverd 
// Presale Contract for Scan Token 
// All Unsold Tokens will burn after Presale  
/**
 * @title SafeMath
...
contract preSaleScan is Owned {
    using SafeMath for uint256;
    address public tokenAddress;
    bool public saleOpen;
    uint256 tokenRatePerEth = 1000; 
    ...
    receive() external payable{
        require(saleOpen, "Sale is not open");
        require(usersInvestments[msg.sender].add(msg.value) <= 100 ether, "Max investment allowed is 100 ether");
