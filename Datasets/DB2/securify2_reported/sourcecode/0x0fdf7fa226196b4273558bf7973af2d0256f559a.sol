...
contract P3XRoll {
    ...
    address constant private P3X_ADDRESS = address(0xD26B63194F70E0939393D23D3A5b1ed6BDE5f835);

    IP3X constant private p3xContract = IP3X(P3X_ADDRESS);

    

    address constant private DEV = address(0x8948E4B00DEB0a5ADb909F4DC5789d20D0851D71);
