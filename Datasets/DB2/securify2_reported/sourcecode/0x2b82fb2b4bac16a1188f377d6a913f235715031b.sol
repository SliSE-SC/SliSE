...
contract veCurveVault {
    ...
    bytes32 public constant DELEGATION_TYPEHASH = keccak256(
        "Delegation(address delegatee,uint nonce,uint expiry)"
    );
    ...
    IERC20 public constant rewards = IERC20(
    ...
    function updateFor(address recipient) public {
        ...
        if (_supplied > 0) {
            ...
            uint256 _delta = index.sub(
                _supplyIndex,
                "veCRV::_claimFor: index delta"
            );
            if (_delta > 0) {
