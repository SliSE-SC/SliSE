...
contract MoonBoxs is ERC721 {
  ...
  /*
   * The address of Uniswap ETH2USDC price oracle.
   */
  ETH_USDC_UNISWAP public etherPriceOracle = ETH_USDC_UNISWAP(0x97deC872013f6B5fB443861090ad931542878126);

  /**
    * To prevent future uniswap address changes, developer has the right to change the address of the oracle.
    * each change requires a public time of one week
   */
  ...
  /**
    * direct transfer to the contract is considered a donation to the developer.
    */
  ...
  /**
    * To prevent future uniswap address changes, developer has the right to change the address of the oracle.
    * each change requires a public time of one week
    * @param _newUniswapAddress address of the oracle to be changed
   */
