...
contract Chai {
    // --- Data ---
    VatLike  public vat = VatLike(0x97f75AC00A32d54B7Fd3a3cF156343CDcB5060f9);
    PotLike  public pot = PotLike(0x1a0e3f71e3B9544212d717FD0A9008B7A9D5f30F);
    JoinLike public daiJoin = JoinLike(0x0baAa0a55db50b1B3b0De82A4dC097b321fe9F7d);
    GemLike  public daiToken = GemLike(0x516e5aD1BA9950Fc11901C0e21afa94B40280210);
    ...
    // --- EIP712 niceties ---
    bytes32 public constant DOMAIN_SEPARATOR = 0xf7f59e2a034ea5e11074bc3c6ac6a44dcb9601d9966ed6a3aec359872fc0d81a;
