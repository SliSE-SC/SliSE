...
contract TokenWrapper {
    ...
    IERC20 public stakeToken = IERC20( //FIXME
        0x42d5ed414EA6833ad9c506b89a1011537f471f00
    );
...
contract PeerLPPool is TokenWrapper, IRewardDistributionRecipient {
    IERC20 public rewardToken = IERC20(
        0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2
    ); //FIXME
    uint256 public constant DURATION = 2 weeks; 

    uint256 public constant startTime = 1618408800;
