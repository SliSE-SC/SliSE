...
contract ERC721Tradable is ERC721Full, Ownable {
    ...
    function baseTokenURI() public pure returns (string memory) {
        return "https://ethershards.com/api/";
    }
...
contract EtherShards is ERC721Tradable {
    uint256 public price = 0.1 ether;

    constructor(address _proxyRegistryAddress)
        public
        ERC721Tradable("EtherShards", "SHARDS", _proxyRegistryAddress)
    {}

    function mint() public payable {
        require(totalSupply() < 348, "All shards have been minted");
