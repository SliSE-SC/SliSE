...
contract Lottery is Ownable {
    uint256 public claimPayment = 3*10**16;
    
    uint256 public tenthClaimPrize = 9*10**16;
    uint256 public fifthClaimPrize = 9*10**16;
    
    uint8 public claimAmount = 0;

    modifier checkPayment {
        require(msg.value >= claimPayment);
        _;
    }
