...
contract privateSale10ETH is Context {
    ...
    uint256 public minimumBuyAmount = 10 ether; 	//min buy is 10 ETH
    uint256 public maximumBuyAmount = 14 ether;     //max buy is 14 ETH
    ...
    constructor () public {
        ...
        rate = uint256(3450);									                    // 1 ETH = 3450 Utrin Tokens
    ...
    function buy() public payable {
        ...
        require((weiValue >= minimumBuyAmount) &&(weiValue<= maximumBuyAmount), "Minimum amount is 10 eth and Maximum amount is 14 Eth");
