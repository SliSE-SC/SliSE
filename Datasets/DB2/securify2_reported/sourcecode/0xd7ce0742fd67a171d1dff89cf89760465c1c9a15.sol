...
contract EasyToken is ERC20, Ownable, usingOraclize {
     ...
     * @dev Create new EAX token contract.
     ...
     * @param _accountEasyWorld The account for the EAX World tokens that receives 2,000.000,000 tokens on creation.
     ...
     * @dev the send ETH funds are send back to the buyer and no EAX tokens will be delivered.
     ...
     * @dev Deliver the tokens to the user's account and move the ETH balance to the EAX contract.
