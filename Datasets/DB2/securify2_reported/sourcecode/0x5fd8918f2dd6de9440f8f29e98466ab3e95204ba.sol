...
// File: contracts/TFBTokenVesting.sol
...
contract TFBTokenVesting is Ownable {
    ...
    constructor(IERC20 _token) public {
        ...
        addVesting(0x2eB7Df352621FE6F14188AC5A50ada4252925b86, now + 100 * day, 350000000 * SCALING_FACTOR);

        addVesting(0x2eB7Df352621FE6F14188AC5A50ada4252925b86, now + 190 * day, 350000000 * SCALING_FACTOR);

        addVesting(0x2eB7Df352621FE6F14188AC5A50ada4252925b86, now + 280 * day, 350000000 * SCALING_FACTOR);

        addVesting(0x2eB7Df352621FE6F14188AC5A50ada4252925b86, now + 370 * day, 350000000 * SCALING_FACTOR);

        addVesting(0x2eB7Df352621FE6F14188AC5A50ada4252925b86, now + 400 * day, 16000000000 * SCALING_FACTOR);
