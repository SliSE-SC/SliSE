...
// File: contracts/trusttoken/interface/IBurnableERC20.sol
pragma solidity 0.6.10;

/// Interface for burnable ERC20 Token
...
// File: contracts/truefi/interface/IArbitraryDistributor.sol
pragma solidity 0.6.10;
...
// File: contracts/truefi/TrueRatingAgency.sol
pragma solidity 0.6.10;
...
contract TrueRatingAgency is ITrueRatingAgency, Ownable {
    ...
    /**
     * @dev Get armount of tokens claimed by an address given a loan ID
     * @param id Loan ID
     * @param voter Voter address
     * @return Amount of tokens claimed by voter for loan ID
     */
    ...
    /**
     * @dev Get armount of claimable tokens for an address given a loan ID
     * @param id Loan ID
     * @param voter Voter address
     * @return Amount of tokens claimable by voter for loan ID
     */
