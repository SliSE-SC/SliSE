...
contract GOFTokenWrapper {
    ...
    IERC20 public stakeToken = IERC20(0x6aa0ba5BCd234FDd9A17372B40E5fBdb9Dc71bD0);
...
contract GOFGV2YCRVPool is GOFTokenWrapper, IRewardDistributionRecipient {
    
    IERC20 public gof = IERC20(0x488E0369f9BC5C40C002eA7c1fe4fd01A198801c);
    uint256 public constant DURATION = 7 days;

    uint256 public constant startTime = 1605700800; //utc+8 2020-11-18 20:00:00
    ...
    modifier checkStart(){
        require(block.timestamp > startTime,"Golff-POOL: Not start");
        _;
    }
