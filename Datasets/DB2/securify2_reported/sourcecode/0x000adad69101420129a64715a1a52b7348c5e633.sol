...
contract DIP_Team_Transfer is Ownable {
    ...
    address Pool_B = 0x7D96c657F5d721De12060cdc90e6ACa73A5a4E46; // Team & Early Contributors

    address Pool_C = 0x4B7B8c1d236D349D53b2Fb80c060FEF2544cE3E4; // Founders
    ...
    ****************/
    ...
    constructor (/* IERC20 token */) public Ownable() {
        ...
        teamTokens[0xf45a7DcaD497648A36707b07d88D5daA02b6cD1a] = grant(Pool_B, 314000 * DIP);   // #4

        teamTokens[0x1C5f8361B6a789F4a68082c129dF7a2Ab5D85503] = grant(Pool_B, 1000000 * DIP);  // #5

        teamTokens[0x0a4B0a34e9f9989F581D934f98a425f4232b2c1F] = grant(Pool_B, 200 * DIP);      // #6

        teamTokens[0x6da07B9F3C8DBe292Fb87393C60faef5EEbE9f6C] = grant(Pool_C, 200 * DIP);      // #7

        teamTokens[0x12D00e3EE84A67af3D959dc3d30E4a6051C7d14A] = grant(Pool_C, 2000000 * DIP);  // #8
