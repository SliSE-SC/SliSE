...
contract privateSale5ETH is Context {
    ...
    uint256 public minimumBuyAmount = 5 ether; 	//min buy is 5 ETH
    uint256 public maximumBuyAmount = 7 ether;  //max buy is 7 ETH
    ...
    constructor () public {
        ...
        rate = uint256(3200);									                    //this rate means 1 ETH = 3200 Utrin Tokens
    ...
    function buy() public payable {
        ...
        require((weiValue >= minimumBuyAmount) &&(weiValue<= maximumBuyAmount), "Minimum amount is 5 eth and Maximum amount is 7 Eth");
