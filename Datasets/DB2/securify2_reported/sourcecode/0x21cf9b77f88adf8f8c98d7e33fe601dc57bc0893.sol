...
// Dependency file: /Users/present/code/super-sett/deps/@openzeppelin/contracts/math/SafeMath.sol
...
// Root file: contracts/badger-timelock/GovernanceTimelock.sol
...
contract GovernanceTimelock {
    ...
    function setGuardian(address guardian_) public {
        require(msg.sender == admin, "Timelock::setGuardian: Call must come from admin.");
        guardian = guardian_;
