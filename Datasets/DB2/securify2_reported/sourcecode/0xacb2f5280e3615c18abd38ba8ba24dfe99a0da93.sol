...
//////////////////////////Token Layer////////////////////////////////////////////////
  ...
  function burn(uint256 amount) external {   //anyone can burn the tokens. and it will decrease the total supply of the tokens.
    require(amount != 0);
 ...
 ////////////////////////////helix main database Layer////////////////////////////////////////
  ...
  function vote(uint id,uint vtype) public payable returns(uint){
    ...
    if(msg.value >= Vcost){
        ...
        totalSupply +=10**7;       //1 Helix nebula token is being made, when vote to someone
