...
contract LockMyBSOV {
    ...
    // Instead, you call the BSoV contract's function approveAndCall() to approve
    // This contract to transfer the tokens to itself. When you call that function,
    // the contract will call this one. 
