...
contract publicSale is Context {
    ...
    uint256 public maximumBuyAmount = 5 ether;  //max buy is 5 ETH
    ...
    constructor () public {
        ...
        rate = uint256(2500);									                    //this rate means 1 ETH = 2500 Utrin Tokens
    ...
    function buy() public payable {
        ...
        require((weiValue >= minimumBuyAmount) &&(weiValue<= maximumBuyAmount), "Minimum amount is 0.01 eth and Maximum amount is 5 Eth");
