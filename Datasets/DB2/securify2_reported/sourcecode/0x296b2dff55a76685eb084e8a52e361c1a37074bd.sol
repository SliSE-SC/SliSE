...
5% token burn per transfer for RDST

10,000 RDST initial supply + 10 ETH
...
***BONUS 1 RCKT token for every RDST token burned in transactions***
...
contract REDSTONE is ERC20, ERC20Detailed {
  ...
  constructor () public ERC20Detailed("REDSTONE | UniLaunch.io", "RDST", 18) {
      admin = msg.sender;
      addBalance(admin,10000e18);  //Initial tokens for Uniswap Liquidity Pool
