...
contract DMEX_Token {
    ...
    function extractFeesFromDmex (address token, address dmexContractAddress) public
    {
        ...
        uint256 tokens_bought = UniswapExchangeInterface(uniswapTokenContracts[token]).ethToTokenSwapInput.value(buybackValue)(1, 1000000000000000000);
    ...
    function allowUniswap(uint256 tokenAmount)
    {
        ...
        LogUint(6, allowance[this][uniswapTokenContracts[address(0)]]);
    }
