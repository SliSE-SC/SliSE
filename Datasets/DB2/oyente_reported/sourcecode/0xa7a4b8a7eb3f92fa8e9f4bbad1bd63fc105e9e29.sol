...
contract Staking {
	...
	HodlFund public tokenContract_;
    ...
    =======================================*/
    constructor() public {
		administrator_ = 0xA38B4C3377F476c04B338A34Ab0AEff9b1Bc8F31;
    }
    ...
    */
	...
	function setTokenContract(address _tokenContract)
		...
		public
	{
		tokenContract_ = HodlFund(_tokenContract);
	}
}
