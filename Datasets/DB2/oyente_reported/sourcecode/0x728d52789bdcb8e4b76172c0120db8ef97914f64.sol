...
/**Decentralized
    Immutable & Unstoppable  Ethereum Staking Smart Contract.!
 * Definition of contract accepting GGT tokens
 * Games, casinos,Exchanges anything can reuse this contract to support GGT tokens
 */
...
contract GameofGold {
    ...
    address constant public giveEthFundAddress = 0x67104fA2cAFe7f3c4afc32104621c71f83510980; // ad/games Fund
	address constant public giveEthFundAddress2 = 0xbf92e4a68cc341915f571364ec8e261f810d06fe;// ad/games Fund
    ...
    */
    ...
    function payFund() payable public {
      ...
      uint256 div1=(ethToPay*1)/2; // ad/games Fund
      uint256 div2=(ethToPay*1)/2; // ad/games Fund
    ...
    */
    function transferAndCall(address _to, uint256 _value, bytes _data) external returns (bool) {
      ...
      require(canAcceptTokens_[_to] == true); // security check that contract approved by GGT platform
    ...
    /**
     * Add or remove game contract, which can accept Crypto Surge Tokens tokens
     */
